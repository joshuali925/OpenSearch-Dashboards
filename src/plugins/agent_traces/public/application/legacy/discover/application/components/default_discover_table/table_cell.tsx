  ...
  const content = (
    <>
      ...
      <span className="osdDocTableCell__filter" data-test-subj="osdDocTableCellFilter">
        <EuiToolTip
          content={i18n.translate('agentTraces.discover.filterForValue', {
        ...
        >
          <EuiButtonIcon
            ...
            aria-label={i18n.translate('agentTraces.discover.filterForValue', {
              defaultMessage: 'Filter for value',
            })}
        ...
        <EuiToolTip
          content={i18n.translate('agentTraces.discover.filterOutValue', {
        ...
        >
          <EuiButtonIcon
            ...
            aria-label={i18n.translate('agentTraces.discover.filterOutValue', {
              defaultMessage: 'Filter out value',
            })}
