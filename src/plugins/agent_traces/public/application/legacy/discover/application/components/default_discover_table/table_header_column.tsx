...
export function TableHeaderColumn({
  ...
  const getSortButtonAriaLabel = () => {
    const sortAscendingMessage = i18n.translate(
      'agentTraces.discover.docTable.tableHeader.sortByColumnAscendingAriaLabel',
      {
    ...
    const sortDescendingMessage = i18n.translate(
      'agentTraces.discover.docTable.tableHeader.sortByColumnDescendingAriaLabel',
      {
    ...
    const stopSortingMessage = i18n.translate(
      'agentTraces.discover.docTable.tableHeader.sortByColumnUnsortedAriaLabel',
      {
  ...
  const buttons = [
    ...
    // Remove Button
    {
      ...
      ariaLabel: i18n.translate(
        'agentTraces.discover.docTable.tableHeader.removeColumnButtonAriaLabel',
        {
      ...
      tooltip: i18n.translate(
        'agentTraces.discover.docTable.tableHeader.removeColumnButtonTooltip',
        {
    ...
    // Move Left Button
    {
      ...
      ariaLabel: i18n.translate(
        'agentTraces.discover.docTable.tableHeader.moveColumnLeftButtonAriaLabel',
        {
      ...
      tooltip: i18n.translate(
        'agentTraces.discover.docTable.tableHeader.moveColumnLeftButtonTooltip',
        {
    ...
    // Move Right Button
    {
      ...
      ariaLabel: i18n.translate(
        'agentTraces.discover.docTable.tableHeader.moveColumnRightButtonAriaLabel',
        {
      ...
      tooltip: i18n.translate(
        'agentTraces.discover.docTable.tableHeader.moveColumnRightButtonTooltip',
        {
  ...
  return (
    <th
      ...
      role="columnheader"
      aria-label={i18n.translate('agentTraces.discover.defaultTable.docTableHeaderLabel', {
