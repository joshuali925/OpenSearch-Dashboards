        ...
        <EuiPageContent paddingSize="s">
          {reqState === OpenSearchRequestState.NotFoundIndexPattern && (
            <EuiCallOut
              ...
              title={
                <FormattedMessage
                  id="agentTraces.discover.doc.failedToLocateIndexPattern"
          ...
          {reqState === OpenSearchRequestState.NotFound && (
            <EuiCallOut
              ...
              title={
                <FormattedMessage
                  id="agentTraces.discover.doc.failedToLocateDocumentDescription"
                  defaultMessage="Cannot find document"
                />
              }
            >
              <FormattedMessage
                id="agentTraces.discover.doc.couldNotFindDocumentsDescription"
          ...
          {reqState === OpenSearchRequestState.Error && (
            <EuiCallOut
              ...
              title={
                <FormattedMessage
                  id="agentTraces.discover.doc.failedToExecuteQueryDescription"
                  defaultMessage="Cannot run search"
                />
              }
            >
              <FormattedMessage
                id="agentTraces.discover.doc.somethingWentWrongDescription"
              ...
              >
                <FormattedMessage
                  id="agentTraces.discover.doc.somethingWentWrongDescriptionAddon"
          ...
          {reqState === OpenSearchRequestState.Loading && (
            <EuiCallOut data-test-subj={`doc-msg-loading`}>
              ...
              <FormattedMessage
                id="agentTraces.discover.doc.loadingDescription"
