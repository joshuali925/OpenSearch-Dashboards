      ...
      <form onSubmit={onSubmit}>
        ...
        <EuiFlexGroup direction="row" gutterSize="s" responsive={false}>
          <EuiFlexItem grow={false}>
            ...
            >
              <FormattedMessage
                id="agentTraces.discover.context.loadButtonLabel"
                defaultMessage="Load"
              />
            </EuiSmallButtonEmpty>
          </EuiFlexItem>
          <EuiFlexItem grow={false}>
            <EuiCompressedFormRow>
              <EuiCompressedFieldNumber
                aria-label={
                  isSuccessor
                    ? i18n.translate('agentTraces.discover.context.olderDocumentsAriaLabel', {
                        defaultMessage: 'Number of older documents',
                      })
                    : i18n.translate('agentTraces.discover.context.newerDocumentsAriaLabel', {
          ...
          <EuiFlexItem>
            <EuiFormRow display="centerCompressed">
              {isSuccessor ? (
                <FormattedMessage
                  id="agentTraces.discover.context.olderDocumentsDescription"
                  defaultMessage="older documents"
                />
              ) : (
                <FormattedMessage
                  id="agentTraces.discover.context.newerDocumentsDescription"
