    ...
    return (
      <EuiCallOut
        ...
        title={
          docCount === 0 ? (
            <FormattedMessage
              id="agentTraces.discover.context.newerDocumentsWarningZero"
              defaultMessage="No documents newer than the anchor could be found."
            />
          ) : (
            <FormattedMessage
              id="agentTraces.discover.context.newerDocumentsWarning"
  ...
  return (
    <EuiCallOut
      ...
      title={
        docCount === 0 ? (
          <FormattedMessage
            id="agentTraces.discover.context.olderDocumentsWarningZero"
            defaultMessage="No documents older than the anchor could be found."
          />
        ) : (
          <FormattedMessage
            id="agentTraces.discover.context.olderDocumentsWarning"
