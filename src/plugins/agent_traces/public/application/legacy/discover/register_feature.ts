...
export function registerFeature(home: HomePublicPluginSetup) {
  home.featureCatalogue.register({
    id: 'discover',
    title: i18n.translate('agentTraces.discover.discoverTitle', {
      defaultMessage: 'Discover',
    }),
    subtitle: i18n.translate('agentTraces.discover.discoverSubtitle', {
      defaultMessage: 'Search and find insights.',
    }),
    description: i18n.translate('agentTraces.discover.discoverDescription', {
