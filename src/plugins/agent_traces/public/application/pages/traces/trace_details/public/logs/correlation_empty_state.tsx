...
export const CorrelationEmptyState: React.FC<CorrelationEmptyStateProps> = ({ traceDataset }) => {
  ...
  return (
    <EuiEmptyPrompt
      title={
        <h3>
          {i18n.translate('agentTraces.logs.emptyState.correlationNotConfigured', {
      ...
      body={
        <>
          <EuiText size="s" color="subdued">
            {i18n.translate('agentTraces.logs.emptyState.correlationDescription', {
          ...
          <EuiButton size="s" onClick={handleCreateFromTracesDataset} disabled={!traceDataset?.id}>
            {i18n.translate('agentTraces.logs.emptyState.createFromTracesDataset', {
          ...
          {/* TODO */}
          {/* <EuiText size="s">
            {i18n.translate('agentTraces.logs.emptyState.needHelp', {
              defaultMessage: 'Need help?',
            })}{' '}
            <EuiLink onClick={handleLearnMore} disabled={!traceDataset?.id}>
              {i18n.translate('agentTraces.logs.emptyState.learnAboutDataCorrelation', {
