...
export const DatasetLogsTable: React.FC<DatasetLogsTableProps> = ({
  ...
  const columns: Array<EuiBasicTableColumn<LogHit>> = useMemo(() => {
    const allColumns = [
      ...
      {
        field: 'timestamp',
        name: i18n.translate('agentTraces.datasetLogsTable.column.timestamp', {
          defaultMessage: 'Time',
        }),
        sortable: true,
        width: '140px',
      ...
      {
        field: 'level',
        name: i18n.translate('agentTraces.datasetLogsTable.column.level', {
      ...
      {
        field: 'message',
        name: i18n.translate('agentTraces.datasetLogsTable.column.message', {
      ...
      {
        field: 'spanId',
        name: i18n.translate('agentTraces.datasetLogsTable.column.spanId', {
        ...
        expandedRowMap[logId] = (
          <div style={{ width: '100%' }}>
            <EuiText size="s" style={{ marginBottom: '8px', fontWeight: 'bold' }}>
              {i18n.translate('agentTraces.datasetLogsTable.message', {
                defaultMessage: 'Message',
              })}
            </EuiText>
  ...
  if (isLoading) {
    return (
      <div>
        {i18n.translate('agentTraces.datasetLogsTable.loadingLogs', {
