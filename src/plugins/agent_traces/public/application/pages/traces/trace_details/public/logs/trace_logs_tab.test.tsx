...
jest.mock('./url_builder', () => ({
  buildAgentTracesLogsUrl: jest.fn(() => 'https://example.com/logs'),
...
describe('TraceLogsTab', () => {
  ...
  describe('View in Discover Logs button', () => {
    ...
    it('should not show button when no log datasets are available', () => {
      ...
      expect(urlBuilder.buildAgentTracesLogsUrl).not.toHaveBeenCalled();
    });

    it('should handle URL generation errors', () => {
      const consoleSpy = jest.spyOn(console, 'error').mockImplementation(() => {});
      (urlBuilder.buildAgentTracesLogsUrl as jest.Mock).mockImplementationOnce(() => {
