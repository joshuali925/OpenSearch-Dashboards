  ...
  const panels = [
    {
      ...
      items: [
        {
          name: i18n.translate('agentTraces.serviceMap.popup.focusOnService', {
        ...
        {
          name: showDetails
            ? i18n.translate('agentTraces.serviceMap.popup.collapseAllCards', {
                defaultMessage: 'Collapse all cards',
              })
            : i18n.translate('agentTraces.serviceMap.popup.expandAllCards', {
    ...
    <EuiPopover
      button={
        <div style={{ position: 'relative' }}>
          <Handle type="target" position={Position.Left} className="agentTracesServiceNodeHandle" />
          {/* Style for the cards */}
          <div
            className={`agentTracesServiceCard ${
              isSelected ? 'agentTracesServiceCard--selected' : 'agentTracesServiceCard--default'
            }`}
            style={
              {
            ...
            tabIndex={0}
            role="button"
            aria-label={i18n.translate('agentTraces.serviceMap.serviceCard.ariaLabel', {
          ...
          >
            {/* Service name */}
            <div className="agentTracesServiceCard__name">{data.label}</div>

            {/* Metric bars */}
            <div
              className={`agentTracesServiceCard__metrics ${
                showDetails
                  ? 'agentTracesServiceCard__metrics--withDetails'
                  : 'agentTracesServiceCard__metrics--withoutDetails'
              }`}
            >
              {selectedMetrics.includes('requestRate') && (
                <div
                  title={`Request Rate: ${data.spanCount}`}
                  className="agentTracesMetricBar"
                  style={{
                    backgroundColor: 'rgba(0, 0, 255, 0.1)',
                  }}
                >
                  <div
                    className="agentTracesMetricBar__fill"
                    style={
                      {
            ...
            {showDetails && (
              <div className="agentTracesServiceCard__details">
                {/* Request rate */}
                {selectedMetrics.includes('requestRate') && (
                  <div className="agentTracesServiceCard__metricText">
                ...
                {selectedMetrics.includes('errorRate') && (
                  <div
                    className={`agentTracesServiceCard__metricText ${
                      data.errorRate > 0 ? 'agentTracesServiceCard__metricText--error' : ''
                    }`}
                  >
...
const FlowComponent: React.FC<{
  ...
  return (
    <div className="agentTracesServiceMap">
      {isLayoutLoading && (
        <div className="agentTracesServiceMap__loadingOverlay">
      ...
      >
        {/* Service focus panel */}
        <div className="agentTracesServiceFocusPanel">
          <div className="agentTracesServiceFocusPanel__content">
            <EuiComboBox
              placeholder={i18n.translate('agentTraces.serviceMap.placeholder.focusOnService', {
        ...
        {/* Metrics panel */}
        <div className="agentTracesMetricsPanel">
          <EuiTitle size="xxs">
            <h4>
              {i18n.translate('agentTraces.serviceMap.title.metrics', {
          ...
          <div
            role="group"
            aria-label={i18n.translate('agentTraces.serviceMap.ariaLabel.selectMetrics', {
              defaultMessage: 'Select metrics to display',
            })}
          >
            <EuiCheckbox
              id="requestRate"
              label={i18n.translate('agentTraces.serviceMap.checkbox.requestRate', {
            ...
            <EuiCheckbox
              id="errorRate"
              label={i18n.translate('agentTraces.serviceMap.checkbox.errorRate', {
            ...
            <EuiCheckbox
              id="duration"
              label={i18n.translate('agentTraces.serviceMap.checkbox.duration', {
          ...
          {/* Gradient legends */}
          <div className="agentTracesMetricsPanel__legends">
            {selectedMetrics.includes('requestRate') && (
              <div className="agentTracesMetricsPanel__legendItem">
                <div className="agentTracesMetricsPanel__legendTitle">
                  {i18n.translate('agentTraces.serviceMap.legend.requestRate', {
                    defaultMessage: 'Request Rate',
                  })}
                </div>
                <div
                  className="agentTracesMetricsPanel__legendGradient"
                  style={{
                    background:
                      'linear-gradient(to right, rgba(0, 0, 255, 0.2), rgba(0, 0, 255, 0.9))',
                  }}
                />
                <div className="agentTracesMetricsPanel__legendLabels">
                  <span>0</span>
                  <span>
            ...
            {selectedMetrics.includes('errorRate') && (
              <div className="agentTracesMetricsPanel__legendItem">
                <div className="agentTracesMetricsPanel__legendTitle">
                  {i18n.translate('agentTraces.serviceMap.legend.errorRate', {
                    defaultMessage: 'Error Rate',
                  })}
                </div>
                <div
            ...
            {selectedMetrics.includes('duration') && (
              <div className="agentTracesMetricsPanel__legendItem">
                <div className="agentTracesMetricsPanel__legendTitle">
                  {i18n.translate('agentTraces.serviceMap.legend.duration', {
                    defaultMessage: 'Duration',
                  })}
                </div>
                <div
          ...
          >
            {showDetails
              ? i18n.translate('agentTraces.serviceMap.button.collapseCards', {
                  defaultMessage: 'Collapse cards',
                })
              : i18n.translate('agentTraces.serviceMap.button.expandCards', {
        ...
        <Controls
          ...
          className="agentTracesServiceMapControls"
        />
...
export const ServiceMap: React.FC<ServiceMap> = ({
  ...
  if (!hits || hits.length === 0) {
    return (
      <EuiPanel {...panelProps}>
        <div className="agentTracesServiceMap__emptyState">
          {i18n.translate('agentTraces.serviceMap.emptyState.noTraceData', {
  ...
  if (initialNodes.length === 0) {
    return (
      <EuiPanel {...panelProps}>
        <div className="agentTracesServiceMap__emptyState">
          {i18n.translate('agentTraces.serviceMap.emptyState.noServicesFound', {
  ...
  return (
    <EuiPanel {...panelProps}>
      <div className="agentTracesServiceMap__container">
        <ReactFlowProvider>
          <FlowComponent
