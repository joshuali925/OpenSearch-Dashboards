    ...
    <EuiFlexGroup alignItems="center" gutterSize="s" responsive={false}>
              ...
              <EuiToolTip content="Click to copy Trace ID">
                ...
                >
                  <EuiFlexGroup alignItems="center" gutterSize="xs" responsive={false}>
                    <EuiFlexItem grow={false}>
                      <EuiText size="s">
                        {i18n.translate('agentTraces.traceDetails.topNav.traceIdLabel', {
      ...
      <EuiFlexItem grow={false}>
        <EuiButton size="s" onClick={() => setRawModalOpen(true)} data-test-subj="viewRawDataBtn">
          {i18n.translate('agentTraces.traceDetails.topNav.viewRawData', {
      ...
      {isFlyout && (
        <EuiFlexItem grow={false}>
          <EuiLink
            ...
            target="blank"
          >
            {i18n.translate('agentTraces.traceDetails.topNav.openFullPage', {
    ...
    isRawModalOpen ? (
      <EuiOverlayMask>
        <EuiModal onClose={() => setRawModalOpen(false)}>
          <EuiModalHeader>
            <EuiModalHeaderTitle>
              {i18n.translate('agentTraces.traceDetails.modal.rawDataTitle', {
          ...
          <EuiModalFooter>
            <EuiButton onClick={() => setRawModalOpen(false)} fill>
              {i18n.translate('agentTraces.traceDetails.modal.closeButton', {
