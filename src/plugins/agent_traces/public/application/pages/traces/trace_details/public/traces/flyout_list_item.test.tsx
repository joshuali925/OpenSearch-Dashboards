...
describe('FlyoutListItem', () => {
  ...
  it('maintains proper styling', () => {
    ...
    const titleText = screen
      ...
      .closest('.agentTracesFlyoutListItem__titleText');
    const descriptionText = screen
      .getByText('Test Description')
      .closest('.agentTracesFlyoutListItem__descriptionText');

    // Title should have proper styling
    expect(titleText).toHaveClass('agentTracesFlyoutListItem__titleText');

    // Description should have proper styling
    expect(descriptionText).toHaveClass('agentTracesFlyoutListItem__descriptionText');
  });
});
