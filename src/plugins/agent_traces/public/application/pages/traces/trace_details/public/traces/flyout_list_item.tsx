  ...
  const descriptionComponent =
    props.description !== '-' ? (
      <EuiFlexGroup gutterSize="none">
        <EuiFlexItem>
          <EuiText size="s" className="agentTracesFlyoutListItem__descriptionText">
            {props.description}
          </EuiText>
        </EuiFlexItem>
          ...
          {hover && props.addSpanFilter && (
            <EuiToolTip position="top" content="Filter spans on this value">
              <EuiSmallButtonIcon
                ...
                className="agentTracesFlyoutListItem__filterButton"
              />
            </EuiToolTip>
          )}
        </EuiFlexItem>
      ...
      >
        <EuiDescriptionList
          ...
          listItems={[
            {
              title: (
                <EuiText size="s" color="default" className="agentTracesFlyoutListItem__titleText">
                  <b>{props.title}</b>
                </EuiText>
              ),
