...
export const SpanStatusFilter: React.FC<SpanStatusFilterProps> = ({
  ...
  const [options, setOptions] = useState<EuiSelectableOption[]>([
    {
      label: i18n.translate('agentTraces.traceView.filter.error', {
        defaultMessage: 'Error',
      }),
      key: 'error',
    },
    {
      label: i18n.translate('agentTraces.traceView.filter.ok', {
        defaultMessage: 'OK',
      }),
      key: 'ok',
    },
    {
      label: i18n.translate('agentTraces.traceView.filter.unset', {
    ...
    () => (
      <EuiFlexGroup gutterSize="xs" alignItems="center" responsive={false}>
        <EuiFlexItem grow={false}>
          ...
          >
            {i18n.translate('agentTraces.traceView.button.filterByStatus', {
