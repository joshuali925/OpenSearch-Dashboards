...
export const SpanDetailTabs: React.FC<SpanDetailTabsProps> = ({
  ...
  const tabs = useMemo((): TabItem[] => {
    const tabList: TabItem[] = [
      {
        ...
        name: i18n.translate('agentTraces.spanDetailTabs.tab.overview', {
      ...
      name: (
        <EuiFlexGroup gutterSize="s" alignItems="center" responsive={false}>
          <EuiFlexItem grow={false}>
            {i18n.translate('agentTraces.spanDetailTabs.tab.errors', {
    ...
    tabList.push({
      ...
      name: i18n.translate('agentTraces.spanDetailTabs.tab.logs', {
        defaultMessage: 'Logs',
      }),
      content: (
        <SpanLogsTab
    ...
    tabList.push(
      {
        ...
        name: i18n.translate('agentTraces.spanDetailTabs.tab.metadata', {
      ...
      },
      {
        ...
        name: i18n.translate('agentTraces.spanDetailTabs.tab.rawSpan', {
  ...
  return (
    <EuiPanel paddingSize="m" hasShadow={false} className="agentTracesSpanDetailSidebar">
      <div className="agentTracesSpanDetailSidebar__header">
        <EuiFlexGroup justifyContent="spaceBetween" alignItems="center" gutterSize="s">
          <EuiFlexItem>
            <EuiTitle size="s">
              <h2>
                {i18n.translate('agentTraces.spanDetailTabs.header.spanDetail', {
          ...
          {serviceName && (
            <EuiFlexItem grow={false}>
              <EuiButtonEmpty
                ...
                size="xs"
              >
                {i18n.translate('agentTraces.spanDetailTabs.button.back', {
                  defaultMessage: 'Back',
                })}
              </EuiButtonEmpty>
            </EuiFlexItem>
      ...
      <div className="agentTracesSpanDetailSidebar__content">
        <EuiSpacer size="s" />
        {activeTabContent}
      </div>
    </EuiPanel>
