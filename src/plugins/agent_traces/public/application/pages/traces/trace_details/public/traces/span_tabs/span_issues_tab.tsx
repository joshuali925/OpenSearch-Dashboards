...
export const SpanIssuesTab: React.FC<SpanIssuesTabProps> = ({ selectedSpan }) => {
    ...
    return (
      <EuiPanel key={`issue-${index}`} paddingSize="s" color="subdued">
        ...
        {issue.details && (
          <>
            <EuiSpacer size="xs" />
            <div className="agentTracesSpanTabs__issuesContainer">
              <EuiCodeBlock
                language="json"
                paddingSize="s"
                isCopyable
                className="agentTracesSpanTabs__codeBlock"
              >
  ...
  if (!selectedSpan || isEmpty(selectedSpan)) {
    return (
      <EuiText color="subdued" textAlign="center">
        {i18n.translate('agentTraces.spanIssuesTab.noSpanSelected', {
  ...
  if (issues.length === 0) {
    return (
      <EuiText color="subdued" textAlign="center">
        {i18n.translate('agentTraces.spanIssuesTab.noIssues', {
