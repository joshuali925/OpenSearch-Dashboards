      ...
      <EuiFlexGroup gutterSize="xs" alignItems="center">
        ...
        <EuiFlexItem grow={false}>
          <EuiCopy textToCopy={copyValue}>
            {(copy) => (
              <EuiSmallButtonIcon
                aria-label={i18n.translate('agentTraces.spanOverviewTab.copyToClipboard', {
  ...
  if (!selectedSpan || isEmpty(selectedSpan) || !spanData) {
    return (
      <EuiText color="subdued" textAlign="center">
        {i18n.translate('agentTraces.spanOverviewTab.noSpanSelected', {
  ...
  return (
    <div>
      ...
      <EuiFlexGroup gutterSize="l">
        <EuiFlexItem>
          <OverviewField
            label={i18n.translate('agentTraces.spanOverviewTab.serviceIdentifier', {
        ...
        <EuiFlexItem>
          <OverviewField
            label={i18n.translate('agentTraces.spanOverviewTab.spanId', {
      ...
      <EuiFlexGroup gutterSize="l">
        <EuiFlexItem>
          <OverviewField
            label={i18n.translate('agentTraces.spanOverviewTab.startTime', {
        ...
        <EuiFlexItem>
          <OverviewField
            label={i18n.translate('agentTraces.spanOverviewTab.spanStatus', {
            ...
            value={
              <EuiFlexGroup gutterSize="xs" alignItems="center">
                ...
                <EuiFlexItem grow={false}>
                  <EuiText size="s">
                    {hasError
                      ? i18n.translate('agentTraces.spanOverviewTab.error', {
                          defaultMessage: 'Error',
                        })
                      : i18n.translate('agentTraces.spanOverviewTab.ok', {
                          defaultMessage: 'OK',
                        })}
                  </EuiText>
                </EuiFlexItem>
                {hasError && onSwitchToErrorsTab && (
                  <EuiFlexItem grow={false}>
                    <EuiLink color="primary" onClick={onSwitchToErrorsTab}>
                      {i18n.translate('agentTraces.spanOverviewTab.viewErrors', {
      ...
      {(httpUrl || httpMethod || httpStatusCode) && (
        <>
          <EuiTitle size="xs">
            <h3>
              {i18n.translate('agentTraces.spanOverviewTab.request', {
          ...
          {httpUrl && (
            <>
              <EuiText size="s">
                <strong>
                  {i18n.translate('agentTraces.spanOverviewTab.requestUrl', {
              ...
              <EuiFlexGroup gutterSize="xs" alignItems="flexStart">
                ...
                <EuiFlexItem>
                  <EuiLink
                    ...
                    target="_blank"
                    external
                    className="agentTracesSpanTabs__urlLink"
                  >
                    {httpUrl}
                  </EuiLink>
                </EuiFlexItem>
          ...
          <EuiFlexGroup gutterSize="l">
            <EuiFlexItem>
              <OverviewField
                label={i18n.translate('agentTraces.spanOverviewTab.requestMethod', {
            ...
            <EuiFlexItem>
              <OverviewField
                label={i18n.translate('agentTraces.spanOverviewTab.requestCode', {
                ...
                value={
                  httpStatusCode ? (
                    ...
                    <EuiBadge color="success">
                      {i18n.translate('agentTraces.spanOverviewTab.success', {
