  ...
  const tabs = [
    {
      ...
      name: i18n.translate('agentTraces.traceView.tab.timeline', {
    ...
    //   name: i18n.translate('agentTraces.traceView.tab.serviceMap', {
    ...
    // },
    {
      ...
      name: (
        <>
          ...
          {i18n.translate('agentTraces.traceView.tab.spanList', {
  ...
  tabs.push({
    ...
    name: (
      <>
        ...
        {i18n.translate('agentTraces.traceView.tab.logs', {
