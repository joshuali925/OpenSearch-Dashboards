        ...
        {!traceId ? (
          <EuiPanel paddingSize="l">
            <EuiText textAlign="center">
              {i18n.translate('agentTraces.traceView.noSpanSelected', {
                defaultMessage: 'No span selected',
              })}
            </EuiText>
            <EuiSpacer size="s" />
            <EuiText textAlign="center" color="subdued" size="s">
              {i18n.translate('agentTraces.traceView.selectSpanMessage', {
          ...
          <EuiPanel paddingSize="l">
            <div className="agentTracesTraceView__loadingContainer">
          ...
          <>
            <div className="agentTracesTraceView__tabsContainer">
            ...
            {spanFilters.length > 0 && (
              <div className="agentTracesTraceView__filtersContainer">
                <EuiPanel paddingSize="s">
                  <EuiFlexGroup alignItems="center" justifyContent="spaceBetween">
                      ...
                      <EuiFlexGroup gutterSize="s" alignItems="center" wrap>
                        <EuiFlexItem grow={false}>
                          <EuiText size="s" color="subdued">
                            {i18n.translate('agentTraces.traceView.filters.activeFilters', {
                          ...
                          <EuiFlexItem grow={false} key={`filter-${index}`}>
                            <EuiBadge
                              ...
                              iconOnClickAriaLabel={i18n.translate(
                                'agentTraces.traceView.filters.removeFilter',
                                {
                    ...
                    <EuiFlexItem grow={false}>
                      ...
                      >
                        {i18n.translate('agentTraces.traceView.filters.clearAll', {
            ...
            <EuiResizableContainer
              className="agentTracesTraceView__resizableContainer"
            ...
            >
              {(EuiResizablePanel, EuiResizableButton) => (
                <>
                  ...
                  >
                    <div className="agentTracesTraceView__contentPanel">
                      {/* Tab content */}
                      <div ref={mainPanelRef} className="agentTracesTraceView__mainPanel">
                  ...
                  >
                    <div className="agentTracesTraceView__sidebarPanel">
                      <SpanDetailTabs
