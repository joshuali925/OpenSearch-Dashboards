...
describe('TimelineRuler', () => {
  ...
  it('should apply correct CSS classes for first, last, and center ticks', () => {
    ...
    expect(getByTestId('tick-label-0')).toHaveClass('agentTracesTimelineRuler__label--first');
    expect(getByTestId('tick-label-500')).toHaveClass('agentTracesTimelineRuler__label--center');
    expect(getByTestId('tick-label-1000')).toHaveClass('agentTracesTimelineRuler__label--last');
  });
  ...
  it('should render empty when no ticks are provided', () => {
    ...
    expect(container.querySelectorAll('.agentTracesTimelineRuler__tickContainer')).toHaveLength(0);
  });
});
