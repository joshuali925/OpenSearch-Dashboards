...
export const BreakdownFieldSelector: React.FC<BreakdownFieldSelectorProps> = ({ services }) => {
  ...
  return (
    <EuiFlexItem grow={false} className="agentTracesChart__TimechartHeader__breakdown__container">
      <EuiComboBox
        className="agentTracesChart__TimechartHeader__breakdown"
        prepend={
          <EuiText className="agentTracesChart__TimechartHeader__breakdown__prependText" size="s">
            {i18n.translate('agentTraces.discover.timechartHeader.breakdown', {
              defaultMessage: 'Breakdown',
            })}
          </EuiText>
        }
        placeholder={i18n.translate('agentTraces.discover.timechartHeader.breakdown.selectField', {
        ...
        append={
          error ? (
            <EuiFlexGroup
              gutterSize="none"
              className="agentTracesChart__TimechartHeader__breakdown__errorIcon"
            >
