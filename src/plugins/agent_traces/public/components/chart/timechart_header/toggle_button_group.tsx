  ...
  const toggleButtons = [
    {
      ...
      label: (
        <>
          ...
          />
          {i18n.translate('agentTraces.discover.timechartHeaderToggle.histogram', {
    ...
    },
    {
      ...
      label: (
        <>
          ...
          {i18n.translate('agentTraces.discover.timechartHeaderToggle.summary', {
      ...
      >
        ...
        >
          <EuiText style={{ fontWeight: 600 }} size="s">
            {i18n.translate('agentTraces.discover.timechartHeaderToggle.viewAs', {
        ...
        <EuiSplitPanel.Inner paddingSize="none">
          <EuiButtonGroup
            className="agentTracesChartToggleButtonGroup"
