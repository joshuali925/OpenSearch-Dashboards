...
const isOnTracesFlavor = (): boolean => {
  ...
  return currentPath.includes('/agentTraces/traces') || currentHash.includes('/agentTraces/traces');
};
...
export function TraceDetailsView({ hit }: DocViewRenderProps) {
  ...
  if (!traceInfo) {
    return (
      <div className="agentTracesTraceDetailsView__empty">
        <EuiEmptyPrompt
          iconType="search"
          title={
            <h4>
              {i18n.translate('agentTraces.docViews.traceDetails.noTrace.title', {
          ...
          body={
            <>
              <EuiText size="s">
                {i18n.translate('agentTraces.docViews.traceDetails.noTrace.description', {
                  defaultMessage:
              ...
              <EuiText size="xs" color="subdued">
                {i18n.translate('agentTraces.docViews.traceDetails.noTrace.hint', {
  ...
  return (
    <div className="agentTracesTraceDetailsView">
      {isLoading ? (
        <div className="agentTracesTraceDetailsView__loadingContainer">
          <EuiFlexGroup direction="column" alignItems="center" gutterSize="s">
            ...
            <EuiFlexItem grow={false}>
              <EuiText size="s">
                {i18n.translate('agentTraces.docViews.traceDetails.loading', {
        ...
        <div className="agentTracesTraceDetailsView__emptyState">
          <EuiText color="subdued">
            {i18n.translate('agentTraces.docViews.traceDetails.noData', {
