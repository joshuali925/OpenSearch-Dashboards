...
export const ActionButtons: React.FC<ActionButtonsProps> = ({
  ...
  const afterFeedbackTip = i18n.translate('agentTraces.resultsSummary.summary.afterFeedback', {
    defaultMessage:
    ...
    >
      {feedback !== FeedbackStatus.THUMB_DOWN && (
        <EuiSmallButtonIcon
          ...
          title={
            !feedback
              ? i18n.translate('agentTraces.resultsSummary.summary.goodResponse', {
                  defaultMessage: `Good response`,
                })
              : afterFeedbackTip
          }
          onClick={() => onFeedback(true)}
          data-test-subj="agentTracesResultsSummary_summary_buttons_thumbup"
        />
      )}
      {feedback !== FeedbackStatus.THUMB_UP && (
        <EuiSmallButtonIcon
          ...
          title={
            !feedback
              ? i18n.translate('agentTraces.resultsSummary.summary.badResponse', {
          ...
          data-test-subj="agentTracesResultsSummary_summary_buttons_thumbdown"
        />
      )}
      <div className="agentTracesResultsSummary__verticalSeparator" />
      <EuiCopy textToCopy={summary ?? ''}>
        {(copy) => (
          <EuiSmallButtonIcon
            ...
            color="text"
            iconType="copy"
            data-test-subj="agentTracesResultsSummary_summary_buttons_copy"
          />
        )}
      </EuiCopy>
    </EuiFlexGroup>
