...
export const ResultsSummaryContent: React.FC<ResultsSummaryContentProps> = ({
    ...
    if (loading) {
        ...
        <EuiEmptyPrompt
          ...
          title={
            <EuiText color="subdued" size="m" style={{ fontWeight: 600 }}>
              {i18n.translate('agentTraces.resultsSummary.summary.generating', {
      ...
      return (
        <EuiEmptyPrompt
          ...
          title={
            <EuiText color="subdued" size="m" style={{ fontWeight: 600 }}>
              {i18n.translate('agentTraces.resultsSummary.summary.placeholder', {
      ...
      return (
        <>
          <EuiText size="s" data-test-subj="agentTracesResultsSummary_summary_result">
  ...
  return (
    <EuiPanel
      className="agentTracesResultsSummary__summaryContent"
      paddingSize="s"
      borderRadius="none"
      hasShadow={false}
