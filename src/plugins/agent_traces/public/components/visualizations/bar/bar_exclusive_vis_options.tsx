...
export const BarExclusiveVisOptions = ({
  ...
  const sizeModeOptions = [
    {
      id: 'auto',
      label: i18n.translate('agentTraces.stylePanel.bar.sizeModeAuto', {
        defaultMessage: 'Auto',
      }),
    },
    {
      id: 'manual',
      label: i18n.translate('agentTraces.stylePanel.bar.sizeModeManual', {
  ...
  const barAccordionMessage =
    type === 'bar'
      ? i18n.translate('agentTraces.vis.barChart.exclusiveSettings', {
          defaultMessage: 'Bar',
        })
      : i18n.translate('agentTraces.vis.histogramChart.exclusiveSettings', {
    ...
    <StyleAccordion id="barSection" accordionLabel={barAccordionMessage} initialIsOpen={true}>
      {/* {!shouldDisableUseThresholdColor && (
        <EuiFormRow>
          <EuiSwitch
            compressed
            label={i18n.translate('agentTraces.vis.bar.useThresholdColor', {
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.stylePanel.bar.sizeMode', {
          defaultMessage: 'Size',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agentTraces.stylePanel.bar.sizeMode', {
            defaultMessage: 'Size',
          })}
      ...
      {barSizeMode === 'manual' && (
        <>
          ...
          <EuiFlexGroup>
            <EuiFlexItem>
              <EuiFormRow
                label={i18n.translate('agentTraces.stylePanel.bar.barWidth', {
                  defaultMessage: 'Width',
                })}
                helpText={i18n.translate('agentTraces.stylePanel.bar.barWidthHelp', {
            ...
            <EuiFlexItem>
              <EuiFormRow
                label={i18n.translate('agentTraces.stylePanel.bar.barPadding', {
                  defaultMessage: 'Padding',
                })}
                helpText={i18n.translate('agentTraces.stylePanel.bar.barPaddingHelp', {
      ...
      <EuiSwitch
        compressed
        label={i18n.translate('agentTraces.stylePanel.bar.barBorder', {
      ...
      {showBarBorder && (
        <>
          ...
          <EuiFlexGroup>
            <EuiFlexItem>
              <EuiFormRow
                label={i18n.translate('agentTraces.stylePanel.bar.barBorderWidth', {
            ...
            <EuiFlexItem>
              <EuiFormRow
                label={i18n.translate('agentTraces.stylePanel.bar.barBorderColor', {
