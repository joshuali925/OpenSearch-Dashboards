...
export const BucketOptionsPanel = ({ styles, onChange, bucketType }: BucketOptionsPanelProps) => {
  ...
  return (
    <StyleAccordion
      id="bucketSection"
      accordionLabel={i18n.translate('agentTraces.stylePanel.bar.tabs.bucket', {
    ...
    >
      {bucketType !== 'single' && (
        <EuiFormRow
          label={i18n.translate('agentTraces.stylePanel.bar.bucket.type', {
            defaultMessage: 'Type',
          })}
        >
          <EuiSelect
      ...
      {bucketType === 'time' && (
        <EuiFormRow
          label={i18n.translate('agentTraces.stylePanel.bar.bucket.timeUnit', {
      ...
      {(bucketType === 'num' || bucketType === 'single') && (
        <>
          <EuiFormRow
            label={i18n.translate('agentTraces.stylePanel.bar.bucket.size', {
          ...
          <EuiFormRow
            label={i18n.translate('agentTraces.stylePanel.bar.bucket.count', {
