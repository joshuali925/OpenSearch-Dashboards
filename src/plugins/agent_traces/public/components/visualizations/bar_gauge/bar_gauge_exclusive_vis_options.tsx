...
const displayModeOption = [
  {
    id: 'gradient',
    label: i18n.translate('agentTraces.vis.barGauge.displayMode.gradient', {
      defaultMessage: 'Gradient',
    }),
  },
  {
    id: 'stack',
    label: i18n.translate('agentTraces.vis.barGauge.displayMode.stack', {
      defaultMessage: 'Stack',
    }),
  },
  {
    id: 'basic',
    label: i18n.translate('agentTraces.vis.barGauge.displayMode.basic', {
...
const valueDisplayOption = [
  {
    id: 'valueColor',
    label: i18n.translate('agentTraces.vis.barGauge.valueDisplay.valueColor', {
  ...
  {
    id: 'textColor',
    label: i18n.translate('agentTraces.vis.barGauge.valueDisplay.textColor', {
  ...
  {
    id: 'hidden',
    label: i18n.translate('agentTraces.vis.barGauge.valueDisplay.hidden', {
...
export const BarGaugeExclusiveVisOptions = ({
  ...
  const getOrientationOptions = () => {
    const horizontalLabel = i18n.translate('agentTraces.vis.barGauge.orientation.horizontal', {
      defaultMessage: 'Horizontal',
    });
    const verticalLabel = i18n.translate('agentTraces.vis.barGauge.orientation.vertical', {
  ...
  return (
    <StyleAccordion
      id="barGaugeSection"
      accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.barGauge', {
    ...
    >
      <EuiFormRow
        label={i18n.translate('agentTraces.stylePanel.barGauge.exclusive.orientation', {
          defaultMessage: 'Orientation',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agentTraces.stylePanel.barGauge.exclusive.orientation', {
            defaultMessage: 'Orientation',
          })}
          isFullWidth
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.stylePanel.barGauge.exclusive.displayStyle', {
          defaultMessage: 'Display style',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agentTraces.stylePanel.barGauge.exclusive.displayStyle', {
            defaultMessage: 'Display style',
          })}
          isFullWidth
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.stylePanel.barGauge.exclusive.valueDisplay', {
          defaultMessage: 'Value display',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agentTraces.stylePanel.barGauge.exclusive.valueDisplay', {
            defaultMessage: 'Value display',
          })}
          isFullWidth
      ...
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agentTraces.vis.heatmap.showUnfilledArea', {
