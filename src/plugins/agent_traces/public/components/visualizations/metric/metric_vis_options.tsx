      ...
      {hasMappingSelected && (
        <>
          <EuiFlexItem grow={false}>
            <StyleAccordion
              id="metricSection"
              accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.metric', {
            ...
            >
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('agentTraces.vis.metric.useThresholdColor', {
              ...
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('agentTraces.stylePanel.metric.title', {
              ...
              {styleOptions.showTitle && (
                <EuiFormRow
                  label={i18n.translate('agentTraces.vis.metric.title', {
                    defaultMessage: 'Title',
                  })}
                >
                  <DebouncedFieldText
                    value={styleOptions.title || axisColumnMappings[AxisRole.Value]?.name || ''}
                    placeholder={i18n.translate('agentTraces.vis.metric.title', {
                      defaultMessage: 'Title',
                    })}
          ...
          <EuiFlexItem>
            <StyleAccordion
              ...
              accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.metricValueOptions', {
                defaultMessage: 'Value options',
              })}
              initialIsOpen={true}
            >
              <EuiFormRow
                label={i18n.translate('agentTraces.vis.metric.calculation', {
          ...
          <EuiFlexItem>
            <StyleAccordion
              id="metricTextStyles"
              accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.metricTextSize', {
                defaultMessage: 'Text size',
              })}
              initialIsOpen={false}
            >
              <EuiFormRow
                label={i18n.translate('agentTraces.vis.metric.valueFontSize', {
              ...
              <EuiFormRow
                label={i18n.translate('agentTraces.vis.metric.titleFontSize', {
              ...
              <EuiFormRow
                label={i18n.translate('agentTraces.vis.metric.percentageFontSize', {
