...
export const PieExclusiveVisOptions = ({ styles, onChange }: PieVisOptionsProps) => {
  ...
  return (
    <StyleAccordion
      id="pieSection"
      accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.pie', {
        defaultMessage: 'Pie',
      })}
      initialIsOpen={true}
    >
      <EuiFormRow
        label={i18n.translate('agentTraces.vis.pie.exclusive.showAs', {
          defaultMessage: 'Show as',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agentTraces.vis.pie.exclusive.showAs', {
            defaultMessage: 'Show as',
          })}
          options={[
            {
              id: 'pie',
              label: i18n.translate('agentTraces.vis.pie.exclusive.pie', {
                defaultMessage: 'Pie',
              }),
            },
            {
              id: 'donut',
              label: i18n.translate('agentTraces.vis.pie.exclusive.donut', {
      ...
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agentTraces.vis.pie.exclusive.showValues', {
      ...
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agentTraces.vis.pie.exclusive.showLabels', {
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.vis.pie.exclusive.labelTruncate', {
