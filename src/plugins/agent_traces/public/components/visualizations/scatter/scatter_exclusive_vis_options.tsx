...
export const ScatterExclusiveVisOptions = ({
  ...
  return (
    <StyleAccordion
      ...
      id="scatterSection"
      accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.scatter', {
    ...
    >
      {!shouldDisableUseThresholdColor && (
        <EuiFormRow>
          <EuiSwitch
            compressed
            label={i18n.translate('agentTraces.vis.scatter.useThresholdColor', {
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.vis.scatter.shape', {
      ...
      <EuiFormRow>
        <EuiSwitch
          ...
          compressed
          label={i18n.translate('agentTraces.vis.scatter.filled', {
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.vis.scatter.colorScale', {
