...
const disconnectValuesOption = [
  {
    ...
    label: i18n.translate('agentTraces.vis.stateTimeline.disconnectValuesOption.never', {
      defaultMessage: 'Never',
    }),
  },
  {
    id: DisableMode.Threshold,
    label: i18n.translate('agentTraces.vis.stateTimeline.disconnectValuesOption.threshold', {
...
const connectValuesOption = [
  {
    id: DisableMode.Never,
    label: i18n.translate('agentTraces.vis.stateTimeline.connectValuesOption.never', {
      defaultMessage: 'Never',
    }),
  },
  {
    id: DisableMode.Threshold,
    label: i18n.translate('agentTraces.vis.stateTimeline.connectValuesOption.threshold', {
      defaultMessage: 'Threshold',
    }),
  },
];
...
export const StateTimeLineExclusiveVisOptions = ({
  ...
  return (
    <StyleAccordion
      ...
      accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.stateTimeline', {
    ...
    >
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agentTraces.vis.statetimeline.useThresholdColor', {
      ...
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agentTraces.vis.stateTimeline.exclusive.showValues', {
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.vis.stateTimeline.exclusive.rowHeight', {
      ...
      <EuiFormRow
        label={i18n.translate(
          'agentTraces.vis.stateTimeline.exclusive.disconnectValues.disableMode',
          {
      ...
      >
        <EuiButtonGroup
          legend={i18n.translate(
            'agentTraces.stylePanel.texclusive.disconnectValues.disableMode.options',
            {
      ...
      {styles?.disconnectValues?.disableMode === DisableMode.Threshold && (
        <EuiFormRow
          label={i18n.translate(
            'agentTraces.stylePanel.texclusive.disconnectValues.disableMode.threshold',
            {
              defaultMessage: 'Threshold',
            }
          )}
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.vis.stateTimeline.exclusive.connectValues.connectMode', {
          defaultMessage: 'Connect null values',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate(
            'agentTraces.stylePanel.stateTimeline.exclusive.connectValues.options',
            {
      ...
      {styles?.connectNullValues?.connectMode === DisableMode.Threshold && (
        <EuiFormRow
          label={i18n.translate(
            'agentTraces.stylePanel.texclusive.connectValues.connectMode.threshold',
            {
              defaultMessage: 'Threshold',
            }
          )}
