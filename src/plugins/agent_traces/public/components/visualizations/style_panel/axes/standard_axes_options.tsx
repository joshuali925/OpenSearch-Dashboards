...
const xAxisLabel = i18n.translate('agentTraces.vis.standardAxes.xAxis', {
  defaultMessage: 'X-Axis',
});

const yAxisLabel = i18n.translate('agentTraces.vis.standardAxes.yAxis', {
  defaultMessage: 'Y-Axis',
});

const y2AxisLabel = i18n.translate('agentTraces.vis.standardAxes.y2Axis', {
...
export const AllAxesOptions: React.FC<AllAxesOptionsProps> = ({
  ...
  return (
    <StyleAccordion
      id="allAxesSection"
      accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.allAxes', {
        defaultMessage: 'Axes',
      })}
          ...
          <EuiSplitPanel.Inner paddingSize="s" key={axis.axisRole}>
            ...
            <div>
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('agentTraces.vis.standardAxes.showAxis', {
              ...
              {axis.show && (
                <>
                  <EuiFormRow
                    label={i18n.translate('agentTraces.vis.standardAxes.axisTitle', {
                  ...
                  <EuiFormRow
                    label={i18n.translate('agentTraces.vis.standardAxes.axisPosition', {
                  ...
                  {getSchemaByAxis(axisColumnMappings?.[axis.axisRole]) === 'temporal' &&
                    onShowFullTimeRangeChange && (
                      <EuiFormRow>
                        <EuiSwitch
                          compressed
                          label={i18n.translate('agentTraces.vis.standardAxes.showFullTimeRange', {
                    ...
                    <EuiFormRow>
                      <EuiSwitch
                        ...
                        label={i18n.translate(
                          'agentTraces.vis.standardAxes.showAxisGrid.switchLabel',
                          {
                  ...
                  <EuiFormRow>
                    <EuiSwitch
                      compressed
                      label={i18n.translate('agentTraces.vis.standardAxes.showLabels', {
                  ...
                  {axis.labels.show && (
                    <>
                      <EuiFormRow
                        label={i18n.translate('agentTraces.vis.standardAxes.labelAlignment', {
                      ...
                      <EuiFormRow
                        label={i18n.translate('agentTraces.vis.axis.label.truncate.label', {
