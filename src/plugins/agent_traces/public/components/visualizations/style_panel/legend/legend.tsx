...
export const LegendOptionsPanel = ({
  ...
  const legendPositionOptions = [
    {
      ...
      text: i18n.translate('agentTraces.stylePanel.legend.position.right', {
        defaultMessage: 'Right',
      }),
    },
    {
      value: Positions.BOTTOM,
      text: i18n.translate('agentTraces.stylePanel.legend.position.bottom', {
        defaultMessage: 'Bottom',
      }),
    },
    {
      value: Positions.LEFT,
      text: i18n.translate('agentTraces.stylePanel.legend.position.left', {
        defaultMessage: 'Left',
      }),
    },
    {
      value: Positions.TOP,
      text: i18n.translate('agentTraces.stylePanel.legend.position.top', {
        defaultMessage: 'Top',
      }),
    },
  ];
  ...
  return (
    <StyleAccordion
      id="legendSection"
      accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.legend', {
    ...
    >
      <EuiSwitch
        compressed
        label={i18n.translate('agentTraces.stylePanel.legend.mode', {
      ...
      {legendOptions.show && (
        <>
          <EuiSpacer size="s" />
          <EuiFormRow
            label={i18n.translate('agentTraces.stylePanel.legend.position', {
          ...
          {hasSizeLegend && (
            <EuiFormRow
              label={i18n.translate('agentTraces.stylePanel.legend.titleForSize', {
            ...
            >
              <DebouncedFieldText
                ...
                placeholder={i18n.translate(
                  'agentTraces.stylePanel.legend.titleForSize.placeholder',
                  {
