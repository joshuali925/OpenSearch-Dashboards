...
const OPTIONS = [
  {
    text: i18n.translate('agentTraces.vis.stylePanel.percentageColor.standard', {
      defaultMessage: 'Standard',
    }),
    value: 'standard',
  },
  {
    text: i18n.translate('agentTraces.vis.stylePanel.percentageColor.inverted', {
  ...
  return (
    <>
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agentTraces.vis.metric.showPercentage', {
      ...
      {props.showPercentage && (
        <EuiFormRow
          label={i18n.translate('agentTraces.vis.metric.percentageColor', {
