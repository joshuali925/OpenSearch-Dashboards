...
export const MinMaxControls = ({ min, max, onMaxChange, onMinChange }: MinMaxControlsProps) => {
  return (
    <>
      <EuiFormRow
        label={i18n.translate('agentTraces.stylePanel.threshold.base.min', {
          defaultMessage: 'Min',
        })}
        helpText={i18n.translate('agentTraces.stylePanel.threshold.base.min.help', {
      ...
      <EuiFormRow
        label={i18n.translate('agentTraces.stylePanel.threshold.base.max', {
          defaultMessage: 'Max',
        })}
        helpText={i18n.translate('agentTraces.stylePanel.threshold.base.max.help', {
          defaultMessage: 'Leave empty to calculate based on all values',
        })}
      >
        <DebouncedFieldNumber
