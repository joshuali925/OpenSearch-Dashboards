...
export const TitleOptionsPanel: React.FC<TitleOptionsPanelProps> = ({
  ...
  return (
    <StyleAccordion
      id="titleSection"
      accordionLabel={i18n.translate('agentTraces.stylePanel.tabs.title', {
    ...
    >
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agentTraces.stylePanel.title.showTitle', {
      ...
      {titleOptions?.show && (
        <EuiFormRow
          label={i18n.translate('agentTraces.stylePanel.title.displayName', {
        ...
        >
          <DebouncedFieldText
            ...
            placeholder={i18n.translate('agentTraces.stylePanel.title.default', {
