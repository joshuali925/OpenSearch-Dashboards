...
export const UnitPanel = ({ unit, onUnitChange }: UnitPanelProps) => {
  ...
  const inputBoxButton = (
    <EuiFieldText
      ...
      append={
        unit ? (
          <EuiButtonIcon
            aria-label={i18n.translate('agentTraces.stylePanel.tabs.units.input.trash', {
          ...
          <EuiButtonIcon
            aria-label={i18n.translate('agentTraces.stylePanel.tabs.units.input.openMenu', {
  ...
  return (
    <EuiFormRow
      fullWidth={true}
      label={i18n.translate('agentTraces.stylePanel.unit.panel', {
