    ...
    <EuiFlexGroup gutterSize="s" alignItems="center">
      <EuiFlexItem>
        {localMapping.type === 'value' ? (
          <EuiFormRow
            label={i18n.translate('agentTraces.vis.valueMapping.value', {
          ...
          >
            <DebouncedFieldText
              ...
              placeholder={i18n.translate('agentTraces.vis.valueMapping.value.input', {
          ...
          <EuiFormRow
            label={i18n.translate('agentTraces.vis.valueMapping.range', {
      ...
      <EuiFlexItem>
        <EuiFormRow
          label={i18n.translate('agentTraces.vis.valueMapping.displayText', {
        ...
        >
          <DebouncedFieldText
            ...
            placeholder={i18n.translate('agentTraces.vis.valueMapping.displayText.input', {
