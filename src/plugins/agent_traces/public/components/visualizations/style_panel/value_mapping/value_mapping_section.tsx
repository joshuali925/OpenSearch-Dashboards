  ...
  return (
    <>
      ...
      <EuiButton data-test-subj="valueMappingEditButton" onClick={showModal} fullWidth size="s">
        {i18n.translate('agentTraces.stylePanel.valueMapping.editButton', {
    ...
    <EuiModal aria-labelledby="editValueMappingsModal" onClose={onClose}>
      <EuiModalHeader>
        <EuiModalHeaderTitle id="editValueMappingsModalTitle">
          {i18n.translate('agentTraces.stylePanel.editValueMappingsModal.title', {
        ...
        <EuiPopover
          ...
          button={
            <EuiButton size="s" onClick={() => setPopover(!isPopoverOpen)}>
              {i18n.translate('agentTraces.stylePanel.editValueMappingsModal.add.new.button', {
      ...
      <EuiModalFooter>
        <EuiButtonEmpty onClick={onClose}>
          {i18n.translate('agentTraces.stylePanel.editValueMappingsModal.cancel.button', {
            defaultMessage: 'Cancel',
          })}
        </EuiButtonEmpty>
        <EuiButton fill onClick={handleSave}>
          {i18n.translate('agentTraces.stylePanel.editValueMappingsModal.save.button', {
            defaultMessage: 'Save',
          })}
        </EuiButton>
      </EuiModalFooter>
