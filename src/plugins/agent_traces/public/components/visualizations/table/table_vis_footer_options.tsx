...
export const TableFooterOptions: React.FC<TableFooterStyleControlsProps> = ({
  ...
  return (
    <StyleAccordion
      ...
      accordionLabel={i18n.translate('agentTraces.stylePanel.table.footerSection', {
    ...
    >
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agentTraces.stylePanel.table.showFooter', {
      ...
      {styleOptions.showFooter && (
        <>
          <EuiFormRow
            label={i18n.translate('agentTraces.stylePanel.table.calculation', {
          ...
          {canAddCalculation && (
            <EuiFormRow>
              ...
              >
                {i18n.translate('agentTraces.stylePanel.table.addCalculation', {
