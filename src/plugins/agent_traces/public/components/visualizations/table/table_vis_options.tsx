  ...
  return (
    <EuiFlexGroup direction="column" gutterSize="none">
      <EuiFlexItem>
        <StyleAccordion
          id="tableSection"
          accordionLabel={i18n.translate('agentTraces.stylePanel.table.tableSection', {
        ...
        >
          <EuiFormRow
            label={i18n.translate('agentTraces.stylePanel.table.pageSize', {
              defaultMessage: 'Max rows per page',
            })}
          >
            <DebouncedFieldNumber
              compressed
              placeholder={i18n.translate('agentTraces.stylePanel.table.pageSize.placeholder', {
          ...
          <EuiFormRow
            label={i18n.translate('agentTraces.stylePanel.table.globalAlignment', {
          ...
          <EuiFormRow
            label={i18n.translate('agentTraces.stylePanel.table.cellStyle', {
          ...
          <EuiFormRow>
            <EuiSwitch
              compressed
              label={i18n.translate('agentTraces.stylePanel.table.columnFilter', {
      ...
      <EuiFlexItem grow={false}>
        <StyleAccordion
          id="thresholdSection"
          accordionLabel={i18n.translate('agentTraces.stylePanel.table.threshold', {
