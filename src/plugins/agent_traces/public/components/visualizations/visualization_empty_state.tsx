...
export const VisualizationEmptyState = () => {
  const sampleQueries = [
    {
      key: 'faults',
      label: i18n.translate('agentTraces.visualize.emptyState.sampleQuery.faults', {
...
| head 10`,
    ...
    {
      key: 'slow',
      label: i18n.translate('agentTraces.visualize.emptyState.sampleQuery.slowOps', {
...
| head 10`,
  ...
  const refLinkLabel = i18n.translate('agentTraces.visualize.emptyState.docsLink', {
  ...
  return (
    <>
      ...
      <EuiEmptyPrompt
        ...
        title={
          <h3>
            {i18n.translate('agentTraces.visualize.emptyState.title', {
