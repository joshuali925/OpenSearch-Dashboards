        ...
        <EuiPageContent paddingSize="s">
          {reqState === OpenSearchRequestState.NotFoundIndexPattern && (
            <EuiCallOut
              ...
              title={
                <FormattedMessage
                  id="agenticObservability.discover.doc.failedToLocateIndexPattern"
          ...
          {reqState === OpenSearchRequestState.NotFound && (
            <EuiCallOut
              ...
              title={
                <FormattedMessage
                  id="agenticObservability.discover.doc.failedToLocateDocumentDescription"
                  defaultMessage="Cannot find document"
                />
              }
            >
              <FormattedMessage
                id="agenticObservability.discover.doc.couldNotFindDocumentsDescription"
          ...
          {reqState === OpenSearchRequestState.Error && (
            <EuiCallOut
              ...
              title={
                <FormattedMessage
                  id="agenticObservability.discover.doc.failedToExecuteQueryDescription"
                  defaultMessage="Cannot run search"
                />
              }
            >
              <FormattedMessage
                id="agenticObservability.discover.doc.somethingWentWrongDescription"
          ...
          {reqState === OpenSearchRequestState.Loading && (
            <EuiCallOut data-test-subj={`doc-msg-loading`}>
              ...
              <FormattedMessage
                id="agenticObservability.discover.doc.loadingDescription"
