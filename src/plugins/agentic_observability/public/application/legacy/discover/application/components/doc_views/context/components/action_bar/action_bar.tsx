      ...
      <form onSubmit={onSubmit}>
        ...
        <EuiFlexGroup direction="row" gutterSize="s" responsive={false}>
          <EuiFlexItem grow={false}>
            ...
            >
              <FormattedMessage
                id="agenticObservability.discover.context.loadButtonLabel"
                defaultMessage="Load"
              />
            </EuiSmallButtonEmpty>
          </EuiFlexItem>
            ...
            <EuiCompressedFormRow>
              <EuiCompressedFieldNumber
                aria-label={
                  isSuccessor
                    ? i18n.translate(
                        'agenticObservability.discover.context.olderDocumentsAriaLabel',
                        {
                          defaultMessage: 'Number of older documents',
                        }
                      )
                    : i18n.translate(
                        'agenticObservability.discover.context.newerDocumentsAriaLabel',
                        {
          ...
          <EuiFlexItem>
            <EuiFormRow display="centerCompressed">
              {isSuccessor ? (
                <FormattedMessage
                  id="agenticObservability.discover.context.olderDocumentsDescription"
                  defaultMessage="older documents"
                />
              ) : (
                <FormattedMessage
                  id="agenticObservability.discover.context.newerDocumentsDescription"
