        ...
        <EuiPanel paddingSize="l">
          <EuiFlexGroup direction="column" alignItems="center" gutterSize="m">
            ...
            <EuiFlexItem>
              <EuiTitle size="m">
                <h2>
                  {i18n.translate('agenticObservability.discover.noIndexPatterns.selectDataTitle', {
            ...
            <EuiFlexItem>
              <EuiText textAlign="center" color="subdued" size="xs">
                {i18n.translate(
                  'agenticObservability.discover.noIndexPatterns.selectDataDescription',
                  {
                    defaultMessage:
            ...
            <EuiFlexItem>
              <EuiTitle size="xs">
                <h4>
                  {i18n.translate(
                    'agenticObservability.discover.noIndexPatterns.learnMoreAboutQueryLanguages',
                    {
