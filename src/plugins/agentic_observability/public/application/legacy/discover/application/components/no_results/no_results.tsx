    ...
    return [
        ...
        ? [
            {
              id: 'sample_queries',
              name: i18n.translate(
                'agenticObservability.discover.emptyPrompt.sampleQueries.title',
                {
      ...
      ...(savedQueries.length > 0
        ? [
            {
              id: 'saved_queries',
              name: i18n.translate('agenticObservability.discover.emptyPrompt.savedQueries.title', {
      ...
      <>
        <EuiEmptyPrompt
          ...
          title={
            <EuiText size="s">
              <h2>
                {i18n.translate('agenticObservability.discover.emptyPrompt.title', {
          ...
          body={
            <EuiText size="s" data-test-subj="discoverNoResultsTimefilter">
              <p>
                {i18n.translate('agenticObservability.discover.emptyPrompt.body', {
                  defaultMessage:
