...
export function DocViewTableRowIconNoMapping() {
  const ariaLabel = i18n.translate(
    'agenticObservability.discover.docViews.table.noCachedMappingForThisFieldAriaLabel',
    {
      defaultMessage: 'Warning',
    }
  );
  const tooltipContent = i18n.translate(
    'agenticObservability.discover.docViews.table.noCachedMappingForThisFieldTooltip',
    {
      defaultMessage:
