          ...
          <EuiPageContent horizontalPosition="center">
            <EuiEmptyPrompt
              ...
              title={
                <h2>
                  <FormattedMessage
                    id="agenticObservability.discover.uninitializedTitle"
              ...
              body={
                <p>
                  <FormattedMessage
                    id="agenticObservability.discover.uninitializedText"
              ...
              actions={
                ...
                >
                  <FormattedMessage
                    id="agenticObservability.discover.uninitializedRefreshButtonText"
