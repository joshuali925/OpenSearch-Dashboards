...
export function validateTimeRange(
  ...
  if (!fromMoment || !toMoment || !fromMoment.isValid() || !toMoment.isValid()) {
    toastNotifications.addDanger({
      title: i18n.translate('agenticObservability.discover.notifications.invalidTimeRangeTitle', {
        defaultMessage: `Invalid time range`,
      }),
      text: i18n.translate('agenticObservability.discover.notifications.invalidTimeRangeText', {
