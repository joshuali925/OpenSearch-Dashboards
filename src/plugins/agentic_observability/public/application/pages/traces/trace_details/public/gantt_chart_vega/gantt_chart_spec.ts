...
function createTooltipSignal(isEmbedded: boolean): string {
  const embeddedMessage = isEmbedded
    ? "'" +
      i18n.translate('agenticObservability.ganttChart.tooltip.action', {
        defaultMessage: 'Action',
      }) +
      "': '" +
      i18n.translate('agenticObservability.ganttChart.tooltip.clickToViewDetails', {
  ...
  const baseTooltip =
    "'" +
    i18n.translate('agenticObservability.ganttChart.tooltip.service', {
      defaultMessage: 'Service',
    }) +
    "': datum.serviceName, '" +
    i18n.translate('agenticObservability.ganttChart.tooltip.name', { defaultMessage: 'Name' }) +
    "': datum.name, '" +
    i18n.translate('agenticObservability.ganttChart.tooltip.duration', {
      defaultMessage: 'Duration',
    }) +
    "': datum.duration + ' ms', '" +
    i18n.translate('agenticObservability.ganttChart.tooltip.start', { defaultMessage: 'Start' }) +
    "': datum.startTime + ' ms'";
    ...
    axes: [
      {
        ...
        grid: true,
        tickCount: 8,
        title: i18n.translate('agenticObservability.ganttChart.axis.timeTitle', {
        ...
        encode: {
          enter: {
            ...
            tooltip: {
              signal:
                "'" +
                i18n.translate('agenticObservability.ganttChart.tooltip.errorInSpan', {
        ...
        encode: {
          ...
          update: {
            ...
            text: {
              signal:
                'datum.hasError ? "' +
                i18n.translate('agenticObservability.ganttChart.label.error', {
