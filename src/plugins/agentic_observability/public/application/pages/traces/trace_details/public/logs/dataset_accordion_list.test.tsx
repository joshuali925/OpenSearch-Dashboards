...
describe('DatasetAccordionList', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('renders view in explore buttons only for datasets with logs', () => {
      ...
      expect(screen.getByTestId('dataset-view-in-agenticObs-button-dataset-2')).toBeInTheDocument();
      expect(
        screen.queryByTestId('dataset-view-in-agenticObs-button-dataset-3')
