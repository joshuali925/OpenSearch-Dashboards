                ...
                <EuiFlexGroup justifyContent="spaceBetween" alignItems="center">
                    ...
                    <EuiFlexGroup direction="column" gutterSize="xs">
                        ...
                        <EuiFlexGroup gutterSize="s" alignItems="center">
                          <EuiFlexItem grow={false}>
                            <EuiText size="s" style={{ fontWeight: 'bold' }}>
                              {i18n.translate('agenticObservability.traceLogsTab.dataset', {
                      ...
                      <EuiFlexItem>
                        <EuiText size="xs" color="subdued">
                          {i18n.translate('agenticObservability.traceLogsTab.recentResults', {
                  ...
                  {logs.length > 0 && (
                    <EuiFlexItem grow={false}>
                      ...
                      >
                        {i18n.translate('agenticObservability.traceLogsTab.viewInDiscoverLogs', {
              ...
              <div>
                {logs.length > 0 ? (
                  ...
                  <EuiText size="s" color="subdued">
                    {i18n.translate('agenticObservability.traceLogsTab.noLogsForDataset', {
