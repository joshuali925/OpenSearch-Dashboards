...
export const LogsDataTable: React.FC<LogsDataTableProps> = ({
  ...
  const columns: Array<EuiBasicTableColumn<LogHit>> = useMemo(() => {
    const allColumns = [
      {
        field: 'timestamp',
        name: i18n.translate('agenticObservability.logsDataTable.column.timestamp', {
          defaultMessage: 'Time',
        }),
        sortable: true,
        width: '140px',
      ...
      {
        field: 'level',
        name: i18n.translate('agenticObservability.logsDataTable.column.level', {
      ...
      {
        field: 'message',
        name: i18n.translate('agenticObservability.logsDataTable.column.message', {
      ...
      {
        field: 'spanId',
        name: i18n.translate('agenticObservability.logsDataTable.column.spanId', {
  ...
  if (isLoading) {
    return (
      <div>
        {i18n.translate('agenticObservability.logsDataTable.loadingLogs', {
