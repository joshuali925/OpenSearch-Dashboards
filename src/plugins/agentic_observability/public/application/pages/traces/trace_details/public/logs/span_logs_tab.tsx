  ...
  if (logDatasets.length === 0) {
    return (
      <EuiPanel>
        <EuiTitle size="s">
          <h3>
            {i18n.translate('agenticObservability.spanLogsTab.title', {
        ...
        <EuiText size="s" color="subdued">
          {i18n.translate('agenticObservability.spanLogsTab.noDatasets', {
  ...
  return (
    <div>
      <EuiPanel>
        <EuiTitle size="s">
          <h3>
            {i18n.translate('agenticObservability.spanLogsTab.relatedLogs', {
              defaultMessage: 'Related logs for span',
            })}
          </h3>
        </EuiTitle>
        <EuiText size="s" color="subdued">
          {i18n.translate('agenticObservability.spanLogsTab.description', {
