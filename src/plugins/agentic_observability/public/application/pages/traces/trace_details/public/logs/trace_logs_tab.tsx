  ...
  if (logDatasets.length === 0) {
    return (
      <EuiPanel>
        <EuiTitle size="s">
          <h3>
            {i18n.translate('agenticObservability.traceLogsTab.title', {
              defaultMessage: 'Logs',
            })}
          </h3>
        </EuiTitle>
  ...
  return (
    <div>
      <EuiPanel>
        <EuiTitle size="s">
          <h3>
            {i18n.translate('agenticObservability.traceRelatedLogsTab.title', {
              defaultMessage: 'Related logs',
            })}
          </h3>
        </EuiTitle>
        <EuiText size="s" color="subdued">
          {i18n.translate('agenticObservability.traceLogsTab.description', {
