  ...
  const panels = [
    {
      ...
      items: [
        {
          name: i18n.translate('agenticObservability.serviceMap.popup.focusOnService', {
        ...
        {
          name: showDetails
            ? i18n.translate('agenticObservability.serviceMap.popup.collapseAllCards', {
                defaultMessage: 'Collapse all cards',
              })
            : i18n.translate('agenticObservability.serviceMap.popup.expandAllCards', {
    ...
    <EuiPopover
      button={
        <div style={{ position: 'relative' }}>
          <Handle type="target" position={Position.Left} className="agenticObsServiceNodeHandle" />
          {/* Style for the cards */}
          <div
            className={`agenticObsServiceCard ${
              isSelected ? 'agenticObsServiceCard--selected' : 'agenticObsServiceCard--default'
            }`}
            style={
              {
            ...
            tabIndex={0}
            role="button"
            aria-label={i18n.translate('agenticObservability.serviceMap.serviceCard.ariaLabel', {
          ...
          >
            {/* Service name */}
            <div className="agenticObsServiceCard__name">{data.label}</div>

            {/* Metric bars */}
            <div
              className={`agenticObsServiceCard__metrics ${
                showDetails
                  ? 'agenticObsServiceCard__metrics--withDetails'
                  : 'agenticObsServiceCard__metrics--withoutDetails'
              }`}
            >
              {selectedMetrics.includes('requestRate') && (
                <div
                  title={`Request Rate: ${data.spanCount}`}
                  className="agenticObsMetricBar"
                  style={{
                    backgroundColor: 'rgba(0, 0, 255, 0.1)',
                  }}
                >
                  <div
                    className="agenticObsMetricBar__fill"
                    style={
                      {
            ...
            {showDetails && (
              <div className="agenticObsServiceCard__details">
                {/* Request rate */}
                {selectedMetrics.includes('requestRate') && (
                  <div className="agenticObsServiceCard__metricText">
                ...
                {selectedMetrics.includes('errorRate') && (
                  <div
                    className={`agenticObsServiceCard__metricText ${
                      data.errorRate > 0 ? 'agenticObsServiceCard__metricText--error' : ''
                    }`}
                  >
...
const FlowComponent: React.FC<{
  ...
  return (
    <div className="agenticObsServiceMap">
      {isLayoutLoading && (
        <div className="agenticObsServiceMap__loadingOverlay">
      ...
      >
        {/* Service focus panel */}
        <div className="agenticObsServiceFocusPanel">
          <div className="agenticObsServiceFocusPanel__content">
            <EuiComboBox
              placeholder={i18n.translate(
                'agenticObservability.serviceMap.placeholder.focusOnService',
                {
        ...
        {/* Metrics panel */}
        <div className="agenticObsMetricsPanel">
          <EuiTitle size="xxs">
            <h4>
              {i18n.translate('agenticObservability.serviceMap.title.metrics', {
          ...
          <div
            role="group"
            aria-label={i18n.translate('agenticObservability.serviceMap.ariaLabel.selectMetrics', {
              defaultMessage: 'Select metrics to display',
            })}
          >
            <EuiCheckbox
              id="requestRate"
              label={i18n.translate('agenticObservability.serviceMap.checkbox.requestRate', {
            ...
            <EuiCheckbox
              id="errorRate"
              label={i18n.translate('agenticObservability.serviceMap.checkbox.errorRate', {
            ...
            <EuiCheckbox
              id="duration"
              label={i18n.translate('agenticObservability.serviceMap.checkbox.duration', {
          ...
          {/* Gradient legends */}
          <div className="agenticObsMetricsPanel__legends">
            {selectedMetrics.includes('requestRate') && (
              <div className="agenticObsMetricsPanel__legendItem">
                <div className="agenticObsMetricsPanel__legendTitle">
                  {i18n.translate('agenticObservability.serviceMap.legend.requestRate', {
                    defaultMessage: 'Request Rate',
                  })}
                </div>
                <div
                  className="agenticObsMetricsPanel__legendGradient"
                  style={{
                    background:
                      'linear-gradient(to right, rgba(0, 0, 255, 0.2), rgba(0, 0, 255, 0.9))',
                  }}
                />
                <div className="agenticObsMetricsPanel__legendLabels">
                  <span>0</span>
                  <span>
            ...
            {selectedMetrics.includes('errorRate') && (
              <div className="agenticObsMetricsPanel__legendItem">
                <div className="agenticObsMetricsPanel__legendTitle">
                  {i18n.translate('agenticObservability.serviceMap.legend.errorRate', {
                    defaultMessage: 'Error Rate',
                  })}
                </div>
                <div
            ...
            {selectedMetrics.includes('duration') && (
              <div className="agenticObsMetricsPanel__legendItem">
                <div className="agenticObsMetricsPanel__legendTitle">
                  {i18n.translate('agenticObservability.serviceMap.legend.duration', {
                    defaultMessage: 'Duration',
                  })}
                </div>
                <div
          ...
          >
            {showDetails
              ? i18n.translate('agenticObservability.serviceMap.button.collapseCards', {
                  defaultMessage: 'Collapse cards',
                })
              : i18n.translate('agenticObservability.serviceMap.button.expandCards', {
        ...
        <Controls
          ...
          className="agenticObsServiceMapControls"
        />
...
export const ServiceMap: React.FC<ServiceMap> = ({
  ...
  if (!hits || hits.length === 0) {
    return (
      <EuiPanel {...panelProps}>
        <div className="agenticObsServiceMap__emptyState">
          {i18n.translate('agenticObservability.serviceMap.emptyState.noTraceData', {
  ...
  if (initialNodes.length === 0) {
    return (
      <EuiPanel {...panelProps}>
        <div className="agenticObsServiceMap__emptyState">
          {i18n.translate('agenticObservability.serviceMap.emptyState.noServicesFound', {
  ...
  return (
    <EuiPanel {...panelProps}>
      <div className="agenticObsServiceMap__container">
        <ReactFlowProvider>
          <FlowComponent
