...
describe('FlyoutListItem', () => {
  ...
  it('maintains proper styling', () => {
    ...
    const titleText = screen
      ...
      .closest('.agenticObsFlyoutListItem__titleText');
    const descriptionText = screen
      .getByText('Test Description')
      .closest('.agenticObsFlyoutListItem__descriptionText');

    // Title should have proper styling
    expect(titleText).toHaveClass('agenticObsFlyoutListItem__titleText');

    // Description should have proper styling
    expect(descriptionText).toHaveClass('agenticObsFlyoutListItem__descriptionText');
  });
});
