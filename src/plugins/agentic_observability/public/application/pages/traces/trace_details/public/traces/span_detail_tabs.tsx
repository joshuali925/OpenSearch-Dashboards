...
export const SpanDetailTabs: React.FC<SpanDetailTabsProps> = ({
  ...
  const tabs = useMemo((): TabItem[] => {
    const tabList: TabItem[] = [
      {
        ...
        name: i18n.translate('agenticObservability.spanDetailTabs.tab.overview', {
      ...
      name: (
        <EuiFlexGroup gutterSize="s" alignItems="center" responsive={false}>
          <EuiFlexItem grow={false}>
            {i18n.translate('agenticObservability.spanDetailTabs.tab.errors', {
    ...
    tabList.push({
      ...
      name: i18n.translate('agenticObservability.spanDetailTabs.tab.logs', {
        defaultMessage: 'Logs',
      }),
      content: (
        <SpanLogsTab
    ...
    tabList.push(
      {
        ...
        name: i18n.translate('agenticObservability.spanDetailTabs.tab.metadata', {
      ...
      },
      {
        ...
        name: i18n.translate('agenticObservability.spanDetailTabs.tab.rawSpan', {
  ...
  return (
    <EuiPanel paddingSize="m" hasShadow={false} className="agenticObsSpanDetailSidebar">
      <div className="agenticObsSpanDetailSidebar__header">
        <EuiFlexGroup justifyContent="spaceBetween" alignItems="center" gutterSize="s">
          <EuiFlexItem>
            <EuiTitle size="s">
              <h2>
                {i18n.translate('agenticObservability.spanDetailTabs.header.spanDetail', {
          ...
          {serviceName && (
            <EuiFlexItem grow={false}>
              <EuiButtonEmpty
                ...
                size="xs"
              >
                {i18n.translate('agenticObservability.spanDetailTabs.button.back', {
                  defaultMessage: 'Back',
                })}
              </EuiButtonEmpty>
            </EuiFlexItem>
      ...
      <div className="agenticObsSpanDetailSidebar__content">
        <EuiSpacer size="s" />
        {activeTabContent}
      </div>
    </EuiPanel>
