...
export const SpanMetadataTab: React.FC<SpanMetadataTabProps> = ({
    ...
    return (
      <div data-test-subj="span-metadata-tab">
        <EuiText color="subdued" textAlign="center">
          {i18n.translate('agenticObservability.spanMetadataTab.noSpanSelected', {
  ...
  if (
    ...
    return (
      <div data-test-subj="span-metadata-tab">
        <EuiText color="subdued" textAlign="center">
          {i18n.translate('agenticObservability.spanMetadataTab.noAttributes', {
  ...
  return (
    <div data-test-subj="span-metadata-tab">
      {renderSection(
        i18n.translate('agenticObservability.spanMetadataTab.section.http', {
          defaultMessage: 'HTTP',
        }),
      ...
      {renderSection(
        i18n.translate('agenticObservability.spanMetadataTab.section.infrastructure', {
      ...
      {renderSection(
        i18n.translate('agenticObservability.spanMetadataTab.section.application', {
      ...
      {renderSection(
        i18n.translate('agenticObservability.spanMetadataTab.section.attributes', {
