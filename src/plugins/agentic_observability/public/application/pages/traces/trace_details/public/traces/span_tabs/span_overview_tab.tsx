      ...
      <EuiFlexGroup gutterSize="xs" alignItems="center">
        ...
        <EuiFlexItem grow={false}>
          <EuiCopy textToCopy={copyValue}>
            {(copy) => (
              <EuiSmallButtonIcon
                aria-label={i18n.translate('agenticObservability.spanOverviewTab.copyToClipboard', {
  ...
  if (!selectedSpan || isEmpty(selectedSpan) || !spanData) {
    return (
      <EuiText color="subdued" textAlign="center">
        {i18n.translate('agenticObservability.spanOverviewTab.noSpanSelected', {
  ...
  return (
    <div>
      ...
      <EuiFlexGroup gutterSize="l">
        <EuiFlexItem>
          <OverviewField
            label={i18n.translate('agenticObservability.spanOverviewTab.serviceIdentifier', {
        ...
        <EuiFlexItem>
          <OverviewField
            label={i18n.translate('agenticObservability.spanOverviewTab.spanId', {
      ...
      <EuiFlexGroup gutterSize="l">
        <EuiFlexItem>
          <OverviewField
            label={i18n.translate('agenticObservability.spanOverviewTab.startTime', {
        ...
        <EuiFlexItem>
          <OverviewField
            label={i18n.translate('agenticObservability.spanOverviewTab.spanStatus', {
            ...
            value={
              <EuiFlexGroup gutterSize="xs" alignItems="center">
                ...
                <EuiFlexItem grow={false}>
                  <EuiText size="s">
                    {hasError
                      ? i18n.translate('agenticObservability.spanOverviewTab.error', {
                          defaultMessage: 'Error',
                        })
                      : i18n.translate('agenticObservability.spanOverviewTab.ok', {
                          defaultMessage: 'OK',
                        })}
                  </EuiText>
                </EuiFlexItem>
                {hasError && onSwitchToErrorsTab && (
                  <EuiFlexItem grow={false}>
                    <EuiLink color="primary" onClick={onSwitchToErrorsTab}>
                      {i18n.translate('agenticObservability.spanOverviewTab.viewErrors', {
      ...
      {(httpUrl || httpMethod || httpStatusCode) && (
        <>
          <EuiTitle size="xs">
            <h3>
              {i18n.translate('agenticObservability.spanOverviewTab.request', {
          ...
          {httpUrl && (
            <>
              <EuiText size="s">
                <strong>
                  {i18n.translate('agenticObservability.spanOverviewTab.requestUrl', {
              ...
              <EuiFlexGroup gutterSize="xs" alignItems="flexStart">
                    ...
                    {(copy) => (
                      <EuiSmallButtonIcon
                        aria-label={i18n.translate(
                          'agenticObservability.spanOverviewTab.copyToClipboard',
                          {
                            defaultMessage: 'Copy to clipboard',
                          }
                        )}
                ...
                <EuiFlexItem>
                  <EuiLink
                    ...
                    target="_blank"
                    external
                    className="agenticObsSpanTabs__urlLink"
                  >
                    {httpUrl}
                  </EuiLink>
                </EuiFlexItem>
          ...
          <EuiFlexGroup gutterSize="l">
            <EuiFlexItem>
              <OverviewField
                label={i18n.translate('agenticObservability.spanOverviewTab.requestMethod', {
            ...
            <EuiFlexItem>
              <OverviewField
                label={i18n.translate('agenticObservability.spanOverviewTab.requestCode', {
                ...
                value={
                  httpStatusCode ? (
                    ...
                    <EuiBadge color="success">
                      {i18n.translate('agenticObservability.spanOverviewTab.success', {
