  ...
  const tabs = [
    {
      ...
      name: i18n.translate('agenticObservability.traceView.tab.timeline', {
    ...
    //   name: i18n.translate('agenticObservability.traceView.tab.serviceMap', {
    ...
    // },
    {
      ...
      name: (
        <>
          ...
          {i18n.translate('agenticObservability.traceView.tab.spanList', {
  ...
  tabs.push({
    ...
    name: (
      <>
        ...
        {i18n.translate('agenticObservability.traceView.tab.logs', {
