        ...
        {!traceId ? (
          <EuiPanel paddingSize="l">
            <EuiText textAlign="center">
              {i18n.translate('agenticObservability.traceView.noSpanSelected', {
                defaultMessage: 'No span selected',
              })}
            </EuiText>
            <EuiSpacer size="s" />
            <EuiText textAlign="center" color="subdued" size="s">
              {i18n.translate('agenticObservability.traceView.selectSpanMessage', {
          ...
          <EuiPanel paddingSize="l">
            <div className="agenticObsTraceView__loadingContainer">
          ...
          <>
            <div className="agenticObsTraceView__tabsContainer">
            ...
            {spanFilters.length > 0 && (
              <div className="agenticObsTraceView__filtersContainer">
                <EuiPanel paddingSize="s">
                  <EuiFlexGroup alignItems="center" justifyContent="spaceBetween">
                      ...
                      <EuiFlexGroup gutterSize="s" alignItems="center" wrap>
                        <EuiFlexItem grow={false}>
                          <EuiText size="s" color="subdued">
                            {i18n.translate(
                              'agenticObservability.traceView.filters.activeFilters',
                              {
                          ...
                          <EuiFlexItem grow={false} key={`filter-${index}`}>
                            <EuiBadge
                              ...
                              iconOnClickAriaLabel={i18n.translate(
                                'agenticObservability.traceView.filters.removeFilter',
                                {
                    ...
                    <EuiFlexItem grow={false}>
                      ...
                      >
                        {i18n.translate('agenticObservability.traceView.filters.clearAll', {
            ...
            <EuiResizableContainer
              className="agenticObsTraceView__resizableContainer"
            ...
            >
              {(EuiResizablePanel, EuiResizableButton) => (
                <>
                  ...
                  >
                    <div className="agenticObsTraceView__contentPanel">
                      {/* Tab content */}
                      <div ref={mainPanelRef} className="agenticObsTraceView__mainPanel">
                  ...
                  >
                    <div className="agenticObsTraceView__sidebarPanel">
                      <SpanDetailTabs
