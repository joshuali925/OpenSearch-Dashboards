...
describe('TracesPage', () => {
  ...
  beforeEach(() => {
    ...
    >;
    agenticObsServicesMock.uiSettings.get.mockImplementation((_, defaultValue) => defaultValue);

    agenticObsServicesMock.keyboardShortcut = {
    ...
    (useOpenSearchDashboards as jest.Mock).mockReturnValue({
      services: agenticObsServicesMock,
    });
  });
