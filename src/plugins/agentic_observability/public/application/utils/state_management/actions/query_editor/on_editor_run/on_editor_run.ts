  ...
  if (editorMode === EditorMode.Prompt) {
    ...
    if (!promptModeIsAvailable) {
      services.notifications.toasts.addWarning({
        title: i18n.translate('agenticObservability.queryPanel.queryAssist-not-available-title', {
          defaultMessage: 'Unavailable',
        }),
        text: i18n.translate('agenticObservability.queryPanel.queryAssist-not-available-text', {
