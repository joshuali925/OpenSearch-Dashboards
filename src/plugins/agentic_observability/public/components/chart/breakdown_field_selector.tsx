...
export const BreakdownFieldSelector: React.FC<BreakdownFieldSelectorProps> = ({ services }) => {
  ...
  return (
    <EuiFlexItem grow={false} className="agenticObsChart__TimechartHeader__breakdown__container">
      <EuiComboBox
        className="agenticObsChart__TimechartHeader__breakdown"
        prepend={
          <EuiText className="agenticObsChart__TimechartHeader__breakdown__prependText" size="s">
            {i18n.translate('agenticObservability.discover.timechartHeader.breakdown', {
              defaultMessage: 'Breakdown',
            })}
          </EuiText>
        }
        placeholder={i18n.translate(
          'agenticObservability.discover.timechartHeader.breakdown.selectField',
          {
        ...
        append={
          error ? (
            <EuiFlexGroup
              gutterSize="none"
              className="agenticObsChart__TimechartHeader__breakdown__errorIcon"
            >
