...
export const ExploreLogsChart = ({
  ...
  const timeChartHeader = (
    <div className="agenticObsChart__TimechartHeader" data-test-subj="dscChartTimechartHeader">
      <TimechartHeader
        title={i18n.translate('agenticObservability.discover.timechartHeader.logCount', {
        ...
        <EuiFlexItem grow={false}>
          <section
            aria-label={i18n.translate(
              'agenticObservability.discover.histogramOfFoundDocumentsAriaLabel',
              {
                defaultMessage: 'Histogram of found documents',
              }
            )}
            className="agenticObsTimechart"
            data-test-subj="dscTimechart"
          >
            <div className="agenticObsHistogram" data-test-subj="discoverChart">
              <DiscoverHistogram
                chartData={chartData}
