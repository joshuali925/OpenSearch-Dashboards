...
const getFieldMissingMessage = (
  ...
  if (timeFieldName && fieldName === timeFieldName) {
    return i18n.translate('agenticObservability.traces.error.missingDynamicTimeField', {
      defaultMessage:
  ...
  const fieldMessages: Record<string, string> = {
    durationInNanos: i18n.translate('agenticObservability.traces.error.missingDurationField', {
      defaultMessage:
        'Duration field "durationInNanos" not found in this dataset. This field is required for latency metrics.',
    }),
    status: i18n.translate('agenticObservability.traces.error.missingStatusField', {
      defaultMessage:
        'Status field "status" not found in this dataset. This field is required for error metrics.',
    }),
    endTime: i18n.translate('agenticObservability.traces.error.missingEndTimeField', {
      defaultMessage:
  ...
  return (
    ...
    i18n.translate('agenticObservability.traces.error.missingGenericField', {
      defaultMessage:
...
export const ExploreTracesChart = ({
  ...
  const requestChartTitle = i18n.translate('agenticObservability.traces.requestChart.title', {
    defaultMessage: 'Request Count',
  });

  const errorChartTitle = i18n.translate('agenticObservability.traces.errorChart.title', {
    defaultMessage: 'Error Count',
  });

  const latencyChartTitle = i18n.translate('agenticObservability.traces.latencyChart.title', {
    defaultMessage: 'Latency (ms)',
  });

  const timeChartHeader = showHistogram ? (
    // When expanded, show individual chart titles spread out
    <div className="agenticObsChart__TimechartHeader" data-test-subj="dscChartTimechartHeader">
      <EuiFlexGroup alignItems="center" gutterSize="s">
        <EuiFlexItem className="agenticObsTracesChart__headerItem">
          <h4 className="agenticObsTracesChart__title">{requestChartTitle}</h4>
        </EuiFlexItem>
        <EuiFlexItem className="agenticObsTracesChart__headerItem">
          <h4 className="agenticObsTracesChart__title">{errorChartTitle}</h4>
        </EuiFlexItem>
        <EuiFlexItem className="agenticObsTracesChart__headerItem">
          <h4 className="agenticObsTracesChart__title">{latencyChartTitle}</h4>
        </EuiFlexItem>
      </EuiFlexGroup>
    </div>
  ) : (
    ...
    <div className="agenticObsChart__TimechartHeader" data-test-subj="dscChartTimechartHeader">
      <TimechartHeader
        title={i18n.translate('agenticObservability.discover.timechartHeader.traces', {
  ...
  const toggleLabel = i18n.translate('agenticObservability.discover.histogram.collapse', {
  ...
  const queryEnhancedHistogramHeader = (
    <EuiFlexGroup
      direction="row"
      gutterSize="m"
      className="agenticObsChart__chartheader"
      data-test-subj="dscChartChartheader"
    >
      <EuiFlexItem grow={false}>{toggle}</EuiFlexItem>
      <EuiFlexItem grow={true} className="agenticObsChart__chartheaderContent">
        {timeChartHeader}
      </EuiFlexItem>
    </EuiFlexGroup>
  );
  ...
  return (
    <EuiFlexGroup
      direction="column"
      gutterSize="none"
      className="agenticObsChart__wrapper agenticObsChart__wrapper--enhancement"
    ...
    >
      ...
      {showHistogram && (
        <EuiFlexGroup direction="row" gutterSize="m">
          ...
          <EuiFlexItem grow={false} className="agenticObsTracesChart__spacer" />
          {/* Request Count Chart - Fixed Container */}
          <EuiFlexItem className="agenticObsTracesChart__container">
            <section
              aria-label={i18n.translate('agenticObservability.traces.requestChartAriaLabel', {
                defaultMessage: 'Request count histogram',
              })}
              className="agenticObsTimechart agenticObsTimechart--request agenticObsTracesChart__section"
              data-test-subj="agenticObsTimechart-request"
            >
              <div
                className="agenticObsHistogram agenticObsHistogram--request agenticObsTracesChart__histogram"
                data-test-subj="agenticObsChart-request"
              >
                {requestChartData ? (
                  <DiscoverHistogram
                  ...
                  <EuiCallOut
                    title={i18n.translate('agenticObservability.traces.error.requestChartTitle', {
                  ...
                  <EuiCallOut
                    title={i18n.translate(
                      'agenticObservability.traces.error.requestChartGenericTitle',
                      {
                        defaultMessage: 'Request Count Unavailable',
                      }
                    )}
                  ...
                  >
                    <p>
                      {requestError.originalErrorMessage ||
                        ...
                        requestError.error ||
                        i18n.translate('agenticObservability.traces.error.requestChartFallback', {
                          defaultMessage:
                  ...
                  <div className="agenticObsTracesChart__loading">
          ...
          <EuiFlexItem className="agenticObsTracesChart__container">
            <section
              aria-label={i18n.translate('agenticObservability.traces.errorChartAriaLabel', {
                defaultMessage: 'Error count histogram',
              })}
              className="agenticObsTimechart agenticObsTimechart--error agenticObsTracesChart__section"
              data-test-subj="agenticObsTimechart-error"
            >
              <div
                className="agenticObsHistogram agenticObsHistogram--error agenticObsTracesChart__histogram"
                data-test-subj="agenticObsChart-error"
              >
                {errorChartData ? (
                  <DiscoverHistogram
                  ...
                  <EuiCallOut
                    title={i18n.translate('agenticObservability.traces.error.errorChartTitle', {
                  ...
                  <EuiCallOut
                    title={i18n.translate(
                      'agenticObservability.traces.error.errorChartGenericTitle',
                      {
                        defaultMessage: 'Error Count Unavailable',
                      }
                    )}
                  ...
                  >
                    <p>
                      {errorQueryError.originalErrorMessage ||
                        ...
                        i18n.translate('agenticObservability.traces.error.errorChartFallback', {
                          defaultMessage:
          ...
          <EuiFlexItem className="agenticObsTracesChart__container">
            <section
              aria-label={i18n.translate('agenticObservability.traces.latencyChartAriaLabel', {
                defaultMessage: 'Average latency chart',
              })}
              className="agenticObsTimechart agenticObsTimechart--latency agenticObsTracesChart__section"
              data-test-subj="agenticObsTimechart-latency"
            >
              <div
                className="agenticObsHistogram agenticObsHistogram--latency agenticObsTracesChart__histogram"
                data-test-subj="agenticObsChart-latency"
              >
                {latencyChartData ? (
                  <DiscoverHistogram
                  ...
                  <EuiCallOut
                    title={i18n.translate('agenticObservability.traces.error.latencyChartTitle', {
                  ...
                  <EuiCallOut
                    title={i18n.translate(
                      'agenticObservability.traces.error.latencyChartGenericTitle',
                      {
                        defaultMessage: 'Latency Unavailable',
                      }
                    )}
                  ...
                  >
                    <p>
                      {latencyError.originalErrorMessage ||
                        ...
                        latencyError.error ||
                        i18n.translate('agenticObservability.traces.error.latencyChartFallback', {
                          defaultMessage:
