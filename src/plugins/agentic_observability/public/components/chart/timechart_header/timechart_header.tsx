  ...
  return (
    <I18nProvider>
      <EuiFlexGroup gutterSize="s" responsive alignItems="center" justifyContent="flexEnd">
        <EuiFlexItem grow={false} className="agenticObsChart__TimechartHeader__logCount">
          <EuiText
            className="agenticObsChart__TimechartHeader__logCount__text"
          ...
          <>
            {!hideIntervalSelector && (
              <EuiFlexItem grow={false}>
                <EuiSelect
                  className="agenticObsChart__TimechartHeader__selection"
                  aria-label={i18n.translate(
                    'agenticObservability.discover.timechartHeader.timeIntervalSelect.ariaLabel',
                    {
                  ...
                  prepend={
                    <EuiText
                      className="agenticObsChart__TimechartHeader__selection__prependText"
                      data-test-subj="discoverTimechartHeaderInterval"
                      size="s"
                    >
                      {i18n.translate('agenticObservability.discover.timechartHeader.interval', {
                    ...
                    bucketInterval.scaled ? (
                      <EuiIconTip
                        ...
                        content={i18n.translate(
                          'agenticObservability.discover.bucketIntervalTooltip',
                          {
                            defaultMessage:
