  ...
  const toggleButtons = [
    {
      ...
      label: (
        <>
          ...
          />
          {i18n.translate('agenticObservability.discover.timechartHeaderToggle.histogram', {
    ...
    },
    {
      ...
      label: (
        <>
          ...
          {i18n.translate('agenticObservability.discover.timechartHeaderToggle.summary', {
      ...
      >
        ...
        >
          <EuiText style={{ fontWeight: 600 }} size="s">
            {i18n.translate('agenticObservability.discover.timechartHeaderToggle.viewAs', {
        ...
        <EuiSplitPanel.Inner paddingSize="none">
          <EuiButtonGroup
            className="agenticObsChartToggleButtonGroup"
