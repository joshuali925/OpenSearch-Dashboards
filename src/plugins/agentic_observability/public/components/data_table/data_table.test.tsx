...
describe('DefaultDiscoverTable', () => {
  ...
  docViewsRegistry.addDocView({
    title: i18n.translate('agenticObservability.docViews.table.tableTitle', {
  ...
  docViewsRegistry.addDocView({
    title: i18n.translate('agenticObservability.docViews.json.jsonTitle', {
      defaultMessage: 'JSON',
    }),
    order: 20,
  ...
  describe('Column Width Algorithm', () => {
    ...
    it('should render table with proper structure', () => {
      ...
      expect(table).toHaveClass('agenticObs-table');
    });
