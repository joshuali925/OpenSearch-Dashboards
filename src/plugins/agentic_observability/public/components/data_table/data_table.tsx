...
const DataTableUI = ({
  ...
  return (
    <div className="agenticObs-table-container">
      {showPagination ? (
        <Pagination
          pageCount={pageCount}
      ...
      <table data-test-subj="docTable" className="agenticObs-table table">
        <thead>
      ...
      {!showPagination && rows.length === sampleSize && (
        <EuiCallOut className="agenticObsTable__footer" data-test-subj="discoverDocTableFooter">
          <FormattedMessage
            id="agenticObservability.howToSeeOtherMatchingDocumentsDescription"
          ...
          <EuiSmallButtonEmpty onClick={scrollToTop}>
            <FormattedMessage
              id="agenticObservability.backToTopLinkText"
