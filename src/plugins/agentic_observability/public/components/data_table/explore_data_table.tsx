...
const ExploreDataTableComponent = () => {
  ...
  const expandedTableHeader = useMemo(() => {
    ...
    return i18n.translate('agenticObservability.dataTable.expandedRow.documentHeading', {
  ...
  return (
    <div
      ...
      className="agenticObs-table-container eui-xScrollWithShadows"
      ref={containerRef}
    >
      <EuiFlexGroup
        direction="column"
        ...
        className="agenticObs-table-flex-group"
      >
