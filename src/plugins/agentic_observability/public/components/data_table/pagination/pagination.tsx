...
export const Pagination = ({
  ...
  return (
    <EuiFlexGroup
      className="agenticObsDocTable_pagination"
      alignItems="center"
    ...
    >
      {endItem >= sampleSize && (
        <EuiFlexItem grow={false} data-test-subj="osdPaginationLimitsHitMessage">
          <EuiTextColor color="subdued">
            <FormattedMessage
              id="agenticObservability.docTable.limitedSearchResultLabel"
      ...
      <EuiFlexItem grow={false}>
        <FormattedMessage
          id="agenticObservability.docTable.pagerControl.pagesCountLabel"
