...
export const TableCellUI = ({
  ...
  const dataFieldContent =
    isSpanIdColumn(columnId) && isOnTracesPage && rowData && dataset ? (
      ...
      <span
        className="agenticObsDocTableCell__dataField"
  ...
  const content = (
    <>
      {dataFieldContent}
      <span className="agenticObsDocTableCell__filter" data-test-subj="osdDocTableCellFilter">
        ...
        <EuiToolTip
          content={i18n.translate('agenticObservability.filterForValue', {
        ...
        >
          <EuiButtonIcon
            ...
            aria-label={i18n.translate('agenticObservability.filterForValue', {
              defaultMessage: 'Filter for value',
            })}
            data-test-subj="filterForValue"
            className="agenticObsDocTableCell__filterButton"
          />
        </EuiToolTip>
        <EuiToolTip
          content={i18n.translate('agenticObservability.filterOutValue', {
        ...
        >
          <EuiButtonIcon
            ...
            aria-label={i18n.translate('agenticObservability.filterOutValue', {
              defaultMessage: 'Filter out value',
            })}
  ...
  return (
    <td
      ...
      className={`agenticObsDocTableCell ${isTimeField ? 'eui-textNoWrap' : 'eui-textTruncate'}`}
    >
      <div className="agenticObsDocTableCell__content">{content}</div>
    </td>
  );
};
