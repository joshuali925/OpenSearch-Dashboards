...
export const SpanIdLink: React.FC<SpanIdLinkProps> = ({ sanitizedCellValue, rowData, dataset }) => {
  ...
  if (!isValid) {
    ...
    return (
      <EuiToolTip
        content={i18n.translate('agenticObservability.spanIdLink.missingFieldsTooltip', {
          defaultMessage:
  ...
  return (
    <EuiToolTip
      content={i18n.translate('agenticObservability.spanIdLink.redirectTooltip', {
    ...
    >
      <EuiLink
        ...
        className="agenticObsSpanIdLink"
      >
        {displayValue}
...
export const DurationTableCell: React.FC<DurationTableCellProps> = ({ sanitizedCellValue }) => {
  ...
  return (
    <span className="agenticObsDocTableCell__dataField" data-test-subj="osdDocTableCellDataField">
