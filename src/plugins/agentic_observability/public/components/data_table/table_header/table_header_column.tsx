...
export function TableHeaderColumn({ displayName, isRemoveable, name, onRemoveColumn }: Props) {
  ...
  const buttons = [
    // Copy Button
    {
      ...
      ariaLabel: i18n.translate(
        'agenticObservability.docTable.tableHeader.copyColumnButtonAriaLabel',
        {
      ...
      tooltip: i18n.translate('agenticObservability.docTable.tableHeader.copyColumnButtonTooltip', {
    ...
    // Remove Button
    {
      ...
      ariaLabel: i18n.translate(
        'agenticObservability.docTable.tableHeader.removeColumnButtonAriaLabel',
        {
      ...
      tooltip: i18n.translate(
        'agenticObservability.docTable.tableHeader.removeColumnButtonTooltip',
        {
  ...
  return (
    <th
      ...
      className="agenticObsDocTableHeaderField"
      role="columnheader"
      aria-label={i18n.translate('agenticObservability.defaultTable.docTableHeaderLabel', {
          ...
          .map((button, idx) => (
            ...
            >
              <EuiSmallButtonIcon
                ...
                className="agenticObsDocTableHeaderField__actionButton"
