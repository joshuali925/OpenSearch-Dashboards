...
export const ExpandedTableRow: React.FC<ExpandedTableRowProps> = ({
  ...
  const defaultHeader = i18n.translate(
    'agenticObservability.dataTable.expandedRow.documentHeading',
    {
  ...
  return (
    <tr key={'x' + row._id}>
      <td
        className="agenticObsDocTable__detailsParent"
      ...
      >
        <EuiFlexGroup gutterSize="m" alignItems="center">
          <EuiFlexItem
            grow={false}
            className="agenticObsDocTable__detailsIconContainer"
