...
export function DocViewTableRow({
  ...
  const valueClassName = classNames({
    ...
    agenticObsDocViewer__value: true,
  ...
  return (
    <tr key={field} data-test-subj={`tableDocViewRow-${field}`}>
      {typeof onFilter === 'function' && (
        <td className="agenticObsDocViewer__buttons" data-test-subj="osdDocViewerButtons">
      ...
      <td className="agenticObsDocViewer__field" data-test-subj="osdDocViewerField">
        <FieldName
          fieldName={field}
          fieldType={fieldType}
