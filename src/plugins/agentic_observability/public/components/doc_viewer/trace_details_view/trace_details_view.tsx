...
export function TraceDetailsView({ hit }: DocViewRenderProps) {
  ...
  if (!traceInfo) {
    return (
      <div className="agenticObsTraceDetailsView__empty">
        <EuiEmptyPrompt
          iconType="search"
          title={
            <h4>
              {i18n.translate('agenticObservability.docViews.traceDetails.noTrace.title', {
          ...
          body={
            <>
              <EuiText size="s">
                {i18n.translate('agenticObservability.docViews.traceDetails.noTrace.description', {
                  defaultMessage:
              ...
              <EuiText size="xs" color="subdued">
                {i18n.translate('agenticObservability.docViews.traceDetails.noTrace.hint', {
  ...
  return (
    <div className="agenticObsTraceDetailsView">
      {isLoading ? (
        <div className="agenticObsTraceDetailsView__loadingContainer">
          <EuiFlexGroup direction="column" alignItems="center" gutterSize="s">
            ...
            <EuiFlexItem grow={false}>
              <EuiText size="s">
                {i18n.translate('agenticObservability.docViews.traceDetails.loading', {
        ...
        <div className="agenticObsTraceDetailsView__emptyState">
          <EuiText color="subdued">
            {i18n.translate('agenticObservability.docViews.traceDetails.noData', {
