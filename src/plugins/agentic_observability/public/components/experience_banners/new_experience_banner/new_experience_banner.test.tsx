...
describe('NewExperienceBanner', () => {
  ...
  it('renders the banner correctly', () => {
    ...
    expect(screen.getByTestId('agenticObsNewExperienceBanner')).toBeInTheDocument();
  });
  ...
  it('renders the Learn More link correctly', () => {
    render(<NewExperienceBanner />);
    const learnMoreLink = screen.getByTestId('agenticObsNewExperienceBanner__learnMore');
  ...
  it('renders the switch link correctly', () => {
    ...
    Storage.prototype.setItem = jest.fn();
    render(<NewExperienceBanner />);
    fireEvent.click(screen.getByTestId('agenticObsNewExperienceBanner__switch'));
