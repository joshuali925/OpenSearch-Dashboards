...
export const NewExperienceBanner = () => {
  ...
  return isVisible ? (
    <EuiCallOut
      className="agenticObsNewExperienceBanner"
      data-test-subj="agenticObsNewExperienceBanner"
      size="s"
      dismissible={true}
      onDismiss={handleDismiss}
    >
      <span
        className="agenticObsNewExperienceBanner__img"
        role="img"
      ...
      <EuiLink
        ...
        target="_blank"
        data-test-subj="agenticObsNewExperienceBanner__learnMore"
      >
        new discover experience
      </EuiLink>
      , or{' '}
      <EuiLink onClick={handleSwitch} data-test-subj="agenticObsNewExperienceBanner__switch">
