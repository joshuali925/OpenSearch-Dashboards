...
export const DiscoverField = ({
  ...
  const addLabelAria = i18n.translate(
    'agenticObservability.discover.fieldChooser.discoverField.addButtonAriaLabel',
    {
  ...
  const removeLabelAria = i18n.translate(
    'agenticObservability.discover.fieldChooser.discoverField.removeButtonAriaLabel',
    {
  ...
  const infoLabelAria = i18n.translate(
    'agenticObservability.discover.fieldChooser.discoverField.infoButtonAriaLabel',
    {
  ...
  const fieldName = (
    <EuiToolTip delay="long" content={field.name}>
      <span data-test-subj={`field-${field.name}`} className="agenticObsSidebarField__name">
  ...
  if (!isSourceField && !selected) {
    actionButton = (
      <EuiToolTip
        ...
        content={i18n.translate(
          'agenticObservability.discover.fieldChooser.discoverField.addFieldTooltip',
          {
      ...
      >
        <EuiButtonIcon
          ...
          className="agenticObsSidebarField__actionButton"
        />
      </EuiToolTip>
    );
    ...
    actionButton = (
      <EuiToolTip
        delay="long"
        content={i18n.translate(
          'agenticObservability.discover.fieldChooser.discoverField.removeFieldTooltip',
          {
            defaultMessage: 'Remove field from table',
          }
        )}
  ...
  return (
    <EuiFlexGroup
      ...
      alignItems="center"
      responsive={false}
      className="agenticObsSidebarField"
    ...
    >
      ...
      {!isSourceField && (
        <div className="agenticObsSidebarField__actionButtons">
          {showSummary && (
            <EuiPopover
              ownFocus
              display="block"
              ...
              button={
                <EuiToolTip
                  delay="long"
                  content={i18n.translate(
                    'agenticObservability.discover.fieldChooser.discoverField.detailsTooltip',
                    {
              ...
              panelClassName="agenticObsSidebarItem__fieldPopoverPanel"
            >
              <EuiPopoverTitle tabIndex={0}>
                {i18n.translate(
                  'agenticObservability.discover.fieldChooser.discoverField.fieldTopValuesLabel',
                  {
