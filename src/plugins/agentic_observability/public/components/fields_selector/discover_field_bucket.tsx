...
export function DiscoverFieldBucket({ field, bucket, onAddFilter }: Props) {
  const emptyTxt = i18n.translate(
    'agenticObservability.discover.fieldChooser.detailViews.emptyStringText',
    {
      defaultMessage: 'Empty string',
    }
  );
  const addText = i18n.translate(
    'agenticObservability.discover.fieldChooser.detailViews.filterValueButton',
    {
  ...
  const removeText = i18n.translate(
    'agenticObservability.discover.fieldChooser.detailViews.filterOutValueButton',
    {
