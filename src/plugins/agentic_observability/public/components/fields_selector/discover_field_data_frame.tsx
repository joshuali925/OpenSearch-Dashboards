    ...
    <EuiFlexGroup responsive={false} gutterSize="xs">
      <EuiFlexItem grow={false}>
        <EuiButtonEmpty
          ...
          size="xs"
          className="agenticObsSideBar_normalizeIndexPattern"
          data-test-subj="dscSideBarNormalizeIndexPatternButton"
        >
          {i18n.translate(
            'agenticObservability.discover.fieldChooser.dataFrame.normalizeIndexPattern',
            {
      ...
      <EuiFlexItem grow={false}>
        <EuiButtonEmpty
          ...
          size="xs"
          className="agenticObsSideBar_createIndexPattern"
          data-test-subj="dscSideBarCreateIndexPatternButton"
        >
          {i18n.translate(
            'agenticObservability.discover.fieldChooser.dataFrame.createIndexPattern',
            {
