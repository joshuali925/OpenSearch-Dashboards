      ...
      <div className="dscFieldDetails" data-test-subj={`fieldVisualizeContainer`}>
        ...
        {showVisualizeLink && visualizeLink && (
          <div data-test-subj={`fieldVisualizeLink`}>
            ...
            >
              <FormattedMessage
                id="agenticObservability.discover.fieldChooser.detailViews.visualizeLinkText"
          ...
          <EuiText size="xs" textAlign="center">
            {!dataSet.metaFields.includes(field.name) && !field.scripted ? (
              <EuiLink onClick={() => onAddFilter('_exists_', field.name, '+')}>
                <FormattedMessage
                  id="agenticObservability.discover.fieldChooser.detailViews.existsText"
            ...
            / {details.total}{' '}
            <FormattedMessage
              id="agenticObservability.discover.fieldChooser.detailViews.recordsText"
