...
export function DiscoverSidebar(props: DiscoverSidebarProps) {
  ...
  return (
    <I18nProvider>
      <EuiSplitPanel.Outer
        className="agenticObs_fieldSelector_list eui-yScroll"
        aria-label={i18n.translate(
          'agenticObservability.discover.fieldChooser.filter.indexAndFieldsSectionAriaLabel',
          {
      ...
      >
        <EuiSplitPanel.Inner
          grow={false}
          paddingSize="none"
          className="agenticObsSideBar_headerContainer"
        >
        ...
        <EuiSplitPanel.Inner
          grow={false}
          paddingSize="none"
          className="agenticObsSideBar_searchContainer"
        >
          <DiscoverFieldSearch
        ...
        <EuiSplitPanel.Inner
          className="eui-yScroll agenticObsSideBar_fieldListContainer"
          paddingSize="none"
        >
          {(fields.length > 0 || selectedDataSet.fieldsLoading) && (
            <>
              {facetedFields.length > 0 && (
                <FacetList
                  ...
                  title={i18n.translate(
                    'agenticObservability.discover.fieldChooser.filter.facetedFieldsTitle',
                    {
              ...
              <FieldList
                ...
                shortDotsEnabled={shortDotsEnabled}
                title={i18n.translate(
                  'agenticObservability.discover.fieldChooser.filter.selectedFieldsTitle',
                  {
              ...
              {queryFields.length > 0 && (
                <FieldList
                  ...
                  shortDotsEnabled={shortDotsEnabled}
                  title={i18n.translate(
                    'agenticObservability.discover.fieldChooser.filter.queryFieldsTitle',
                    {
              ...
              <FieldList
                ...
                shortDotsEnabled={shortDotsEnabled}
                title={i18n.translate(
                  'agenticObservability.discover.fieldChooser.filter.discoveredFieldsTitle',
                  {
