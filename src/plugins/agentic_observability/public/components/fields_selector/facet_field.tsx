  ...
  return (
    <EuiPanel hasBorder={false} hasShadow={false} color="transparent" paddingSize="none">
      <EuiButtonEmpty
        ...
        size="xs"
        className="agenticObsSideBar__facetField"
        data-test-subj="agenticObsSideBarFacetFieldButton"
      ...
      >
        <EuiFlexGroup
          ...
          alignItems="center"
          responsive={false}
          data-test-subj="agenticObsSidebarField"
        >
        ...
        buckets.map((bucket: Bucket, index) => {
          return (
            <EuiPanel
              ...
              hasShadow={false}
              color="transparent"
              className="agenticObsSideBar__facetValue"
