...
describe('FacetValue', () => {
  ...
  it('shows tooltip with bucket display value', () => {
    ...
    expect(valueSpan).toHaveClass('agenticObsSidebarField__name');
  });
  ...
  it('renders bucket count', () => {
    ...
    expect(countElement).toHaveClass('agenticObsSidebarFacetValue__count');
  });

  it('has correct CSS classes', () => {
    render(<FacetValue {...mockProps} />);

    const container = screen.getByTestId('agenticObsSidebarFacetValue');
    expect(container).toHaveClass('agenticObsSidebarFacetValue');

    const actionButtons = container.querySelector('.agenticObsSidebarField__actionButtons');
    expect(actionButtons).toBeInTheDocument();

    const countElement = container.querySelector('.agenticObsSidebarFacetValue__count');
    expect(countElement).toBeInTheDocument();

    const actionButton = container.querySelector('.agenticObsSidebarField__actionButton');
