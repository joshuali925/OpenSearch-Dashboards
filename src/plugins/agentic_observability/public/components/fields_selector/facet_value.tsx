...
export const FacetValue = ({ field, bucket, onAddFilter, useShortDots }: FacetValueProps) => {
  const filterForLabelAria = i18n.translate(
    'agenticObservability.discover.fieldChooser.discoverField.filterForAriaLabel',
    {
  ...
  const filterOutLabelAria = i18n.translate(
    'agenticObservability.discover.fieldChooser.discoverField.filterOutAriaLabel',
    {
  ...
  const displayValue = (
    <EuiToolTip delay="long" content={bucket.display}>
      <span
        ...
        className="agenticObsSidebarField__name eui-textBreakWord"
      >
  ...
  return (
    <EuiFlexGroup
      ...
      alignItems="center"
      responsive={false}
      className="agenticObsSidebarFacetValue agenticObsSidebarField"
      data-test-subj="agenticObsSidebarFacetValue"
    >
      <EuiFlexItem grow>
        <EuiText size="xs">{displayValue}</EuiText>
      </EuiFlexItem>
      <EuiFlexItem grow={false}>
        <EuiText size="xs" className="agenticObsSidebarFacetValue__count">
          {bucket.count}
        </EuiText>
      </EuiFlexItem>
      <div className="agenticObsSidebarField__actionButtons">
        <EuiToolTip
          ...
          content={i18n.translate(
            'agenticObservability.discover.fieldChooser.discoverField.filterForTooltip',
            {
              defaultMessage: 'Filter for value',
            }
          )}
        ...
        <EuiToolTip
          delay="long"
          content={i18n.translate(
            'agenticObservability.discover.fieldChooser.discoverField.filterOutTooltip',
            {
              defaultMessage: 'Filter out value',
            }
          )}
