...
const QueryPanel = () => {
  ...
  return (
    <EuiPanel paddingSize="s" borderRadius="none" className="agenticObsQueryPanel">
      <QueryPanelWidgets />
      <div className="agenticObsQueryPanel__editorsWrapper">
        <QueryPanelEditor />
      ...
      {isLoading && (
        <EuiProgress
          ...
          color="accent"
          position="absolute"
          data-test-subj="agenticObsQueryPanelIsLoading"
        />
      )}
    </EuiPanel>
  );
