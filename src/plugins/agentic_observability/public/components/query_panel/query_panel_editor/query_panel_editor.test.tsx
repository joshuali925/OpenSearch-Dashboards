...
describe('QueryPanelEditor', () => {
  ...
  it('renders the query panel editor with correct test subject', () => {
    ...
    expect(screen.getByTestId('agenticObsQueryPanelEditor')).toBeInTheDocument();
  ...
  it('applies focused class when editor is focused', () => {
    ...
    const editor = screen.getByTestId('agenticObsQueryPanelEditor');
    expect(editor).toHaveClass('agenticObsQueryPanelEditor--focused');
  });
  ...
  it('does not apply focused class when editor is not focused', () => {
    ...
    const editor = screen.getByTestId('agenticObsQueryPanelEditor');
    expect(editor).not.toHaveClass('agenticObsQueryPanelEditor--focused');
  });
  ...
  it('applies prompt mode class when in prompt mode', () => {
    ...
    const editor = screen.getByTestId('agenticObsQueryPanelEditor');
    expect(editor).toHaveClass('agenticObsQueryPanelEditor--promptMode');
  });
  ...
  it('does not apply prompt mode class when not in prompt mode', () => {
    ...
    const editor = screen.getByTestId('agenticObsQueryPanelEditor');
    expect(editor).not.toHaveClass('agenticObsQueryPanelEditor--promptMode');
  });
  ...
  it('applies prompt is typing class when promptIsTyping is true', () => {
    ...
    const editor = screen.getByTestId('agenticObsQueryPanelEditor');
    expect(editor).toHaveClass('agenticObsQueryPanelEditor--promptIsTyping');
  });
  ...
  it('does not apply prompt is typing class when promptIsTyping is false', () => {
    ...
    const editor = screen.getByTestId('agenticObsQueryPanelEditor');
    expect(editor).not.toHaveClass('agenticObsQueryPanelEditor--promptIsTyping');
  });
