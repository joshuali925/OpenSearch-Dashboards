...
export const useQueryPanelEditor = (): UseQueryPanelEditorReturnType => {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    ...
    category: i18n.translate('agenticObservability.queryPanelEditor.searchCategory', {
  ...
  const placeholder = useMemo(() => {
    const enabledPromptPlaceholder = i18n.translate(
      'agenticObservability.queryPanel.queryPanelEditor.enabledPromptPlaceholder',
      {
    ...
    const disabledPromptPlaceholder = i18n.translate(
      'agenticObservability.queryPanel.queryPanelEditor.disabledPromptPlaceholder',
      {
    ...
    const promptModePlaceholder = i18n.translate(
      'agenticObservability.queryPanel.queryPanelEditor.promptPlaceholder',
      {
