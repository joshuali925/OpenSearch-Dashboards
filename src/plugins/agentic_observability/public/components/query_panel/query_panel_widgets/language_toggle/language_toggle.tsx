...
const promptOptionText = i18n.translate(
  'agenticObservability.queryPanelFooter.languageToggle.promptOption',
  {
    defaultMessage: 'AI',
  }
);
...
export const LanguageToggle = () => {
  ...
  return (
    ...
    <div className="agenticObsLanguageToggle">
      <EuiPopover
        button={
          <EuiBetaBadge
            onClick={onButtonClick}
            data-test-subj="queryPanelFooterLanguageToggle"
            className={classNames('agenticObsLanguageToggle__button', {
              ['agenticObsLanguageToggle__button--aiMode']: isPromptMode,
            })}
            label={badgeLabel}
          />
        }
