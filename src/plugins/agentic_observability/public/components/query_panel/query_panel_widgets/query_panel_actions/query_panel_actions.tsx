      ...
      <EuiPopover
        button={
          <EuiButtonEmpty
            ...
            size="xs"
          >
            <div className="agenticObsQueryPanelActions__buttonTextWrapper">
              <EuiText size="xs">
                {i18n.translate('agenticObservability.queryPanel.actions.actions', {
        ...
        <EuiListGroup>
          {registry.getSortedActions().map((action) => {
            ...
            return (
              <EuiButtonEmpty
                key={action.id}
                className="agenticObsQueryPanelActions__item"
