...
describe('QueryPanelWidgets', () => {
  ...
  describe('component rendering', () => {
    it('renders all basic components with correct layout', () => {
      ...
      expect(container.querySelector('.agenticObsQueryPanelWidgets')).toBeInTheDocument();
      ...
      const separators = container.querySelectorAll(
        '.agenticObsQueryPanelWidgets__verticalSeparator'
      );
  ...
  describe('layout structure', () => {
    it('maintains correct component order in left section', () => {
      ...
      const leftSection = container.querySelector('.agenticObsQueryPanelWidgets__left');
    ...
    it('maintains correct component order in right section', () => {
      ...
      const rightSection = container.querySelector('.agenticObsQueryPanelWidgets__right');
