...
export const QueryPanelWidgets = () => {
  ...
  return (
    <div className="agenticObsQueryPanelWidgets">
      {/* Left Section */}
      <div className="agenticObsQueryPanelWidgets__left">
        <LanguageToggle />
        <DatasetSelectWidget />
        <div className="agenticObsQueryPanelWidgets__verticalSeparator" />
        <RecentQueriesButton />
        <div className="agenticObsQueryPanelWidgets__verticalSeparator" />
        <SaveQueryButton />
      ...
      {/* Right Section */}
      <div className="agenticObsQueryPanelWidgets__right">
        <AskAIButton />
      </div>
    </div>
  );
