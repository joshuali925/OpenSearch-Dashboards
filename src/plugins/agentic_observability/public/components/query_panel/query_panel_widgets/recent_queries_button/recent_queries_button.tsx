...
const label = i18n.translate('agenticObservability.queryPanel.recentQueryLabel', {
...
export const RecentQueriesButton = () => {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    ...
    category: i18n.translate('agenticObservability.keyboardShortcut.category.search', {
    ...
    <EuiPopover
      ...
      button={
        <EuiButtonEmpty
          ...
          data-test-subj="agenticObsRecentQueriesButton"
          size="xs"
        >
          <div className="agenticObsRecentQueriesButton__buttonTextWrapper">
      ...
      panelClassName="agenticObsRecentQueriesButton__popover"
    >
      <RecentQueriesTable
        isVisible={popoverIsOpen}
        queryString={services.data.query.queryString}
        onClickRecentQuery={onClick}
        className="agenticObsRecentQueriesButton__table"
      />
    </EuiPopover>
  );
};
