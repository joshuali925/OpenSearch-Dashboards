  ...
  const handleSaveQuery = async (meta: SavedQueryMeta, saveAsNew?: boolean) => {
    try {
      ...
      services.notifications.toasts.addDanger(
        i18n.translate('agenticObservability.queryPanel.saveQuery.failedToSaveQuery', {
    ...
    <EuiPopover
      button={
        <EuiButtonEmpty
          ...
          size="xs"
        >
          <div className="agenticObsSaveQuery__buttonTextWrapper">
            <EuiIcon type="save" size="s" />
            <EuiText size="xs">
              {i18n.translate('agenticObservability.queryPanel.saveQueryButton.savedQueries', {
      ...
      panelClassName="agenticObsSaveQuery__popoverContent"
    >
      <SavedQueryManagementComponent
