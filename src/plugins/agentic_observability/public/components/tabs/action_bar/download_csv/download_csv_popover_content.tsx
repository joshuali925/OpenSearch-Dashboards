  ...
  const downloadOptions = useMemo(() => {
    const options = [
      {
        ...
        label: (
          <FormattedMessage
            id="agenticObservability.discover.downloadCsvOptionVisible"
    ...
    if (showMaxOption) {
      options.push({
        ...
        label: (
          <FormattedMessage
            id="agenticObservability.discover.downloadCsvOptionMax"
    ...
    <div className="dscDownloadCsvPopoverContent" data-test-subj="dscDownloadCsvPopoverContent">
      <div className="dscDownloadCsvPopoverContent__titleWrapper">
        <EuiText data-test-subj="dscDownloadCsvTitle" size="m">
          <strong>
            <FormattedMessage
              id="agenticObservability.discover.downloadCsvTitle"
      ...
      <div className="dscDownloadCsvPopoverContent__form">
        ...
        >
          <FormattedMessage
            id="agenticObservability.discover.downloadCsvSubmit"
