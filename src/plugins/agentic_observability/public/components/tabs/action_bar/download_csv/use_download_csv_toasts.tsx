...
export const useDiscoverDownloadCsvToasts = () => {
  ...
  const onAbort = () => {
    if (abortControllerRef.current) {
      ...
      toastNotifications.addWarning({
        ...
        iconType: 'alert',
        title: i18n.translate('agenticObservability.discover.downloadCsvCancelledToast', {
    ...
    toastNotifications.addInfo(
      {
        ...
        color: 'primary',
        iconType: 'iInCircle',
        title: i18n.translate('agenticObservability.discover.downloadCsvLoadingToast', {
        ...
        text: ((
          ...
          >
            {i18n.translate('agenticObservability.discover.downloadCsvCancelToast', {
  ...
  const onSuccess = useCallback(() => {
    ...
    toastNotifications.addSuccess({
      ...
      color: 'success',
      iconType: 'check',
      title: i18n.translate('agenticObservability.discover.downloadCsvSuccessToast', {
  ...
  const onError = useCallback(() => {
    ...
    toastNotifications.addDanger({
      ...
      color: 'danger',
      iconType: 'alert',
      title: i18n.translate('agenticObservability.discover.downloadCsvErrorToast', {
