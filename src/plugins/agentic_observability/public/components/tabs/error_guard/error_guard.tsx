...
const detailsText = i18n.translate('agenticObservability.errorPanel.details', {
  defaultMessage: 'Details',
});
const typeText = i18n.translate('agenticObservability.errorPanel.type', {
  defaultMessage: 'Type',
});
  ...
  return (
    <EuiErrorBoundary>
      <EuiFlexGroup direction="column" alignItems="center" className="agenticObsErrorGuard">
        ...
        <div className="agenticObsErrorGuard__errorsSection">
