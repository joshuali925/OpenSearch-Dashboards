...
const noValidPatternsText = i18n.translate(
  'agenticObservability.patternsErrorPanel.noValidPatterns',
  {
    defaultMessage: 'No valid patterns found',
  }
);
const tryDifferentFieldText = i18n.translate(
  'agenticObservability.patternsErrorPanel.tryDifferentField',
  {
