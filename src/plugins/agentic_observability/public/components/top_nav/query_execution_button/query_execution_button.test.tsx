...
describe('QueryExecutionButton', () => {
  ...
  it('renders with correct props', () => {
    ...
    expect(screen.getByTestId('agenticObsQueryExecutionButton')).toBeInTheDocument();
  });
  ...
  it('shows disabled button when date range is invalid', () => {
    ...
    const button = screen.getByTestId('agenticObsQueryExecutionButton');
  ...
  describe('Cancel Button Functionality', () => {
    it('does not render cancel button when not loading and no user initiated query', () => {
      ...
      expect(screen.queryByTestId('agenticObsQueryCancelButton')).not.toBeInTheDocument();
    });
    ...
    it('renders cancel button when loading and user initiated query', () => {
      ...
      expect(screen.getByTestId('agenticObsQueryCancelButton')).toBeInTheDocument();
    });
    ...
    it('calls onCancel when cancel button is clicked', () => {
      ...
      const cancelButton = screen.getByTestId('agenticObsQueryCancelButton');
      cancelButton.click();
    ...
    it('renders both execution and cancel buttons when query is loading and user initiated', () => {
      ...
      expect(
        screen.getByTestId('agenticObsQueryExecutionButton').closest('.euiFlexGroup')
      ).toBeInTheDocument();
    });
    ...
    it('executes onClick handler even when cancel functionality is present', () => {
      ...
      const executionButton = screen.getByTestId('agenticObsQueryExecutionButton');
