...
export const QueryExecutionButton: React.FC<QueryExecutionButtonProps> = ({
  ...
  const buttonText = needsUpdate
    ? i18n.translate('agenticObservability.topNav.queryExecutionButton.update', {
        defaultMessage: 'Update',
      })
    : i18n.translate('agenticObservability.topNav.queryExecutionButton.refresh', {
  ...
  const runButton = (
    <EuiSuperUpdateButton
      ...
      onClick={onClick || (() => {})}
      data-test-subj="agenticObsQueryExecutionButton"
      aria-label={i18n.translate('agenticObservability.topNav.queryExecutionButton.ariaLabel', {
  ...
  const cancelButton = shouldShowCancelButton ? (
    <EuiButtonIcon
      ...
      color="danger"
      onClick={onCancel}
      data-test-subj="agenticObsQueryCancelButton"
      aria-label={i18n.translate(
        'agenticObservability.topNav.queryExecutionButton.cancelAriaLabel',
        {
