...
const savedObjectMetadata = [
  // NOTE: Should saved search be included?
  {
    ...
    name: i18n.translate('agenticObservability.savedSearch.savedObjectName', {
    ...
    <EuiFlyout ownFocus onClose={onClose} data-test-subj="loadSearchForm">
      <EuiFlyoutHeader hasBorder>
        <EuiText size="s">
          <h2>
            <FormattedMessage
              id="agenticObservability.discover.topNav.openSearchPanel.openSavedTitle"
      ...
      <EuiFlyoutBody>
        <SavedObjectFinderUi
          noItemsMessage={
            <FormattedMessage
              id="agenticObservability.topNav.openSearchPanel.noSearchesFoundDescription"
      ...
      <EuiFlyoutFooter>
        <EuiFlexGroup justifyContent="flexEnd">
          <EuiFlexItem grow={false}>
            ...
            >
              <FormattedMessage
                id="agenticObservability.topNav.openSearchPanel.manageSearchesButtonLabel"
