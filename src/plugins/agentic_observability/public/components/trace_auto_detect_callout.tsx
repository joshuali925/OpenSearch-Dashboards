  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      services.notifications.toasts.addSuccess({
        title: i18n.translate('agenticObservability.traces.autoDetect.successTitle', {
          defaultMessage: 'Trace datasets created',
        }),
        text: i18n.translate('agenticObservability.traces.autoDetect.successMessageMultiple', {
          defaultMessage:
      ...
      services.notifications.toasts.addDanger({
        title: i18n.translate('agenticObservability.traces.autoDetect.errorTitle', {
          ...
          <EuiFlexGroup direction="column" alignItems="center" gutterSize="m">
            ...
            <EuiFlexItem>
              <EuiTitle size="m">
                <h2>
                  <FormattedMessage
                    id="agenticObservability.traces.autoDetect.title"
            ...
            <EuiFlexItem>
              <EuiText textAlign="center" color="subdued" size="s">
                <p>
                  <FormattedMessage
                    id="agenticObservability.traces.autoDetect.description"
                    ...
                    <React.Fragment key={index}>
                      ...
                      {detection.tracesDetected && detection.tracePattern && (
                        <li style={{ marginLeft: detection.dataSourceTitle ? '20px' : '0' }}>
                          ...
                          <FormattedMessage
                            id="agenticObservability.traces.autoDetect.tracesLabel"
                      ...
                      {detection.logsDetected && detection.logPattern && (
                        <li style={{ marginLeft: detection.dataSourceTitle ? '20px' : '0' }}>
                          ...
                          <FormattedMessage
                            id="agenticObservability.traces.autoDetect.correlatedLogsLabel"
              ...
              <EuiFlexGroup gutterSize="s" justifyContent="center">
                <EuiFlexItem grow={false}>
                  <EuiButton onClick={handleCreate} isLoading={isCreating} fill>
                    <FormattedMessage
                      id="agenticObservability.traces.autoDetect.createButton"
                ...
                <EuiFlexItem grow={false}>
                  <EuiButtonEmpty onClick={handleDismiss}>
                    <FormattedMessage
                      id="agenticObservability.traces.autoDetect.dismissButton"
