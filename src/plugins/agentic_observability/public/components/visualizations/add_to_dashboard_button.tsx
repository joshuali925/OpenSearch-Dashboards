...
export const SaveAndAddButtonWithModal = ({ dataset }: { dataset?: IndexPattern | Dataset }) => {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    ...
    category: i18n.translate('agenticObservability.addToDashboard.dataActionsCategory', {
  ...
  const handleSave = async ({
    ...
    try {
      ...
      if (dashboardId) {
          ...
          <div>
            {url ? (
              <EuiText size="s">
                <p>
                  ...
                  <EuiLink href={url} target="_blank">
                    {i18n.translate(
                      'agenticObservability.addToDashboard.notification.success.viewDashboardLink',
                      {
              ...
              <EuiText size="s" color="danger">
                {i18n.translate(
                  'agenticObservability.addToDashboard.notification.failure.message',
                  {
        ...
        if (mode === 'new') {
          toastNotifications.add({
            title: i18n.translate('agenticObservability.addToDashboard.notification.success.new', {
          ...
          toastNotifications.add({
            title: i18n.translate(
              'agenticObservability.addToDashboard.notification.success.existing',
              {
      ...
      toastNotifications.add({
        title: i18n.translate('agenticObservability.addToDashboard.notification.fail', {
  ...
  return (
    <>
      ...
      >
        {i18n.translate('agenticObservability.addtoDashboardButton.name', {
          defaultMessage: 'Add to dashboard',
        })}
      </EuiButtonEmpty>
