    ...
    return (
      <EuiFlexItem style={{ width: '100%' }}>
        <EuiCallOut
          title={
            <FormattedMessage
              id="agenticObservability.addtoDashboardModal.duplicateTitleLabel"
        ...
        >
          <p>
            <FormattedMessage
              id="agenticObservability.addtoDashboardModal.duplicateTitleDescription"
    ...
    <EuiModal style={{ minWidth: 400 }} onClose={onCancel}>
      <EuiModalHeader>
        <EuiModalHeaderTitle>
          <h2 data-test-subj="addToDashboardModalTitle">
            {i18n.translate('agenticObservability.addtoDashboardModal.title', {
        ...
        >
          <EuiFlexItem grow={false}>
            <EuiRadio
              ...
              label={i18n.translate('agenticObservability.addtoDashboardModal.saveToExisting', {
          ...
          <EuiFlexItem grow={false}>
            <EuiRadio
              ...
              label={i18n.translate('agenticObservability.addToNewDashboardModal.saveToNew', {
          ...
          {selectedOption === 'existing' && (
            <EuiFlexItem style={{ width: '100%' }}>
              <EuiFormRow
                label={i18n.translate('agenticObservability.addtoDashboardModal.selectDashboard', {
          ...
          {selectedOption === 'new' && (
            <EuiFlexItem style={{ width: '100%' }}>
              <EuiFormRow
                label={i18n.translate('agenticObservability.addtoDashboardModal.dashboardName', {
      ...
      <EuiModalFooter>
        <EuiSmallButtonEmpty onClick={onCancel} data-test-subj="saveToDashboardCancelButton">
          {i18n.translate('agenticObservability.addtoDashboardModal.cancelButton', {
        ...
        >
          {i18n.translate('agenticObservability.addtoDashboardModal.addButton', {
            defaultMessage: 'Add',
          })}
        </EuiSmallButton>
      </EuiModalFooter>
