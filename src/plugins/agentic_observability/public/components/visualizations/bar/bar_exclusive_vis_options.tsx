...
export const BarExclusiveVisOptions = ({
  ...
  const sizeModeOptions = [
    {
      id: 'auto',
      label: i18n.translate('agenticObservability.stylePanel.bar.sizeModeAuto', {
        defaultMessage: 'Auto',
      }),
    },
    {
      id: 'manual',
      label: i18n.translate('agenticObservability.stylePanel.bar.sizeModeManual', {
  ...
  const barAccordionMessage =
    type === 'bar'
      ? i18n.translate('agenticObservability.vis.barChart.exclusiveSettings', {
          defaultMessage: 'Bar',
        })
      : i18n.translate('agenticObservability.vis.histogramChart.exclusiveSettings', {
    ...
    <StyleAccordion id="barSection" accordionLabel={barAccordionMessage} initialIsOpen={true}>
      {/* {!shouldDisableUseThresholdColor && (
        <EuiFormRow>
          <EuiSwitch
            compressed
            label={i18n.translate('agenticObservability.vis.bar.useThresholdColor', {
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.bar.sizeMode', {
          defaultMessage: 'Size',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agenticObservability.stylePanel.bar.sizeMode', {
            defaultMessage: 'Size',
          })}
      ...
      {barSizeMode === 'manual' && (
        <>
          ...
          <EuiFlexGroup>
            <EuiFlexItem>
              <EuiFormRow
                label={i18n.translate('agenticObservability.stylePanel.bar.barWidth', {
                  defaultMessage: 'Width',
                })}
                helpText={i18n.translate('agenticObservability.stylePanel.bar.barWidthHelp', {
            ...
            <EuiFlexItem>
              <EuiFormRow
                label={i18n.translate('agenticObservability.stylePanel.bar.barPadding', {
                  defaultMessage: 'Padding',
                })}
                helpText={i18n.translate('agenticObservability.stylePanel.bar.barPaddingHelp', {
      ...
      <EuiSwitch
        compressed
        label={i18n.translate('agenticObservability.stylePanel.bar.barBorder', {
      ...
      {showBarBorder && (
        <>
          ...
          <EuiFlexGroup>
            <EuiFlexItem>
              <EuiFormRow
                label={i18n.translate('agenticObservability.stylePanel.bar.barBorderWidth', {
            ...
            <EuiFlexItem>
              <EuiFormRow
                label={i18n.translate('agenticObservability.stylePanel.bar.barBorderColor', {
