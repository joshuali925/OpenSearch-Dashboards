...
const displayModeOption = [
  {
    id: 'gradient',
    label: i18n.translate('agenticObservability.vis.barGauge.displayMode.gradient', {
      defaultMessage: 'Gradient',
    }),
  },
  {
    id: 'stack',
    label: i18n.translate('agenticObservability.vis.barGauge.displayMode.stack', {
      defaultMessage: 'Stack',
    }),
  },
  {
    id: 'basic',
    label: i18n.translate('agenticObservability.vis.barGauge.displayMode.basic', {
...
const valueDisplayOption = [
  {
    id: 'valueColor',
    label: i18n.translate('agenticObservability.vis.barGauge.valueDisplay.valueColor', {
  ...
  {
    id: 'textColor',
    label: i18n.translate('agenticObservability.vis.barGauge.valueDisplay.textColor', {
  ...
  {
    id: 'hidden',
    label: i18n.translate('agenticObservability.vis.barGauge.valueDisplay.hidden', {
...
export const BarGaugeExclusiveVisOptions = ({
  ...
  const getOrientationOptions = () => {
    const horizontalLabel = i18n.translate(
      'agenticObservability.vis.barGauge.orientation.horizontal',
      {
        defaultMessage: 'Horizontal',
      }
    );
    const verticalLabel = i18n.translate('agenticObservability.vis.barGauge.orientation.vertical', {
  ...
  return (
    <StyleAccordion
      id="barGaugeSection"
      accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.barGauge', {
    ...
    >
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.barGauge.exclusive.orientation', {
          defaultMessage: 'Orientation',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agenticObservability.stylePanel.barGauge.exclusive.orientation', {
            defaultMessage: 'Orientation',
          })}
          isFullWidth
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.barGauge.exclusive.displayStyle', {
          defaultMessage: 'Display style',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate(
            'agenticObservability.stylePanel.barGauge.exclusive.displayStyle',
            {
              defaultMessage: 'Display style',
            }
          )}
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.barGauge.exclusive.valueDisplay', {
          defaultMessage: 'Value display',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate(
            'agenticObservability.stylePanel.barGauge.exclusive.valueDisplay',
            {
              defaultMessage: 'Value display',
            }
          )}
      ...
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agenticObservability.vis.heatmap.showUnfilledArea', {
