      ...
      {hasMappingSelected && (
        <>
          <EuiFlexItem grow={false}>
            <StyleAccordion
              id="gaugeSection"
              accordionLabel={i18n.translate('agenticObservability.stylePanel.gauge', {
            ...
            >
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('agenticObservability.vis.gauge.useThresholdColor', {
              ...
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('agenticObservability.stylePanel.gauge.title', {
              ...
              {styleOptions.showTitle && (
                <EuiFormRow>
                  <DebouncedFieldText
                    ...
                    placeholder={i18n.translate('agenticObservability.vis.gauge.title', {
          ...
          <EuiFlexItem>
            <StyleAccordion
              ...
              accordionLabel={i18n.translate('agenticObservability.stylePanel.gaugeValueOptions', {
                defaultMessage: 'Value options',
              })}
              initialIsOpen={false}
            >
              <EuiFormRow
                label={i18n.translate('agenticObservability.vis.gauge.calculation', {
