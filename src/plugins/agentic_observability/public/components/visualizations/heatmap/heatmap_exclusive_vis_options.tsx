...
export const HeatmapExclusiveVisOptions = ({
  ...
  return (
    <StyleAccordion
      id="heatmapSection"
      accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.heatmap', {
    ...
    >
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agenticObservability.vis.heatmap.useThresholdColor', {
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.heatmap.exclusive.colorSchema', {
      ...
      <EuiFormRow>
        <EuiSwitch
          ...
          label={i18n.translate(
            'agenticObservability.stylePanel.heatmap.exclusive.reverseColorSchema',
            {
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.heatmap.exclusive.colorScale', {
          defaultMessage: 'Color scale',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agenticObservability.stylePanel.heatmap.exclusive.colorScale', {
            defaultMessage: 'Color scale',
          })}
          isFullWidth
          options={[
            {
              id: 'linear',
              label: i18n.translate(
                'agenticObservability.stylePanel.heatmap.exclusive.scaleType.linear',
                {
            ...
            },
            {
              id: 'log',
              label: i18n.translate(
                'agenticObservability.stylePanel.heatmap.exclusive.scaleType.log',
                {
                  defaultMessage: 'Log',
                }
              ),
            },
            {
              id: 'sqrt',
              label: i18n.translate(
                'agenticObservability.stylePanel.heatmap.exclusive.scaleType.sqrt',
                {
                  defaultMessage: 'Sqrt',
                }
              ),
      ...
      <EuiFormRow>
        <EuiSwitch
          ...
          label={i18n.translate(
            'agenticObservability.stylePanel.heatmap.exclusive.scaleToDataBounds',
            {
      ...
      <EuiFormRow>
        <EuiSwitch
          ...
          label={i18n.translate(
            'agenticObservability.stylePanel.heatmap.exclusive.percentageMode',
            {
      ...
      <EuiFormRow
        label={i18n.translate(
          'agenticObservability.stylePanel.heatmap.exclusive.maxNumberOfColors',
          {
  ...
  return (
    <>
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agenticObservability.stylePanel.heatmap.label.showLabels', {
      ...
      {styles.show && (
        <>
          <EuiFormRow>
            <EuiSwitch
              compressed
              label={i18n.translate('agenticObservability.stylePanel.heatmap.label.rotate', {
          ...
          <EuiFormRow>
            <EuiSwitch
              compressed
              label={i18n.translate(
                'agenticObservability.stylePanel.heatmap.label.overwriteColor',
                {
          ...
          {styles.overwriteColor && (
            <EuiFormRow
              label={i18n.translate('agenticObservability.stylePanel.heatmap.label.color', {
