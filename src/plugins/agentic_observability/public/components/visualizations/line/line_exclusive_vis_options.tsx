...
export const LineExclusiveVisOptions = ({
  ...
  return (
    <StyleAccordion
      id="lineSection"
      accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.line', {
        defaultMessage: 'Line',
      })}
      initialIsOpen={true}
    ...
    >
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.basic.linestyle', {
          defaultMessage: 'Style',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agenticObservability.stylePanel.basic.linestyle', {
            defaultMessage: 'Style',
          })}
          options={[
            {
              id: 'both',
              label: i18n.translate('agenticObservability.stylePanel.basic.lineWithDots', {
                defaultMessage: 'Default',
              }),
            },
            {
              id: 'line',
              label: i18n.translate('agenticObservability.stylePanel.basic.lineOnly', {
                defaultMessage: 'Line only',
              }),
            },
            {
              id: 'dots',
              label: i18n.translate('agenticObservability.stylePanel.basic.dotsOnly', {
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.basic.lineMode', {
          defaultMessage: 'Interpolation',
        })}
      >
        <EuiButtonGroup
          legend={i18n.translate('agenticObservability.stylePanel.basic.lineMode', {
            defaultMessage: 'Interpolation',
          })}
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.stylePanel.basic.linewidth', {
      ...
      >
        <EuiRange
          ...
          max={10}
          step={1}
          aria-label={i18n.translate('agenticObservability.stylePanel.basic.linewidth', {
            defaultMessage: 'Line width',
          })}
          showLabels
          showValue
      ...
      {shouldShowTimeMarker && (
        <EuiFormRow
          label={i18n.translate('agenticObservability.stylePanel.basic.showTimeMarker', {
