      ...
      {hasMappingSelected && (
        <>
          <EuiFlexItem grow={false}>
            <StyleAccordion
              id="metricSection"
              accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.metric', {
            ...
            >
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('agenticObservability.vis.metric.useThresholdColor', {
              ...
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('agenticObservability.stylePanel.metric.title', {
              ...
              {styleOptions.showTitle && (
                <EuiFormRow
                  label={i18n.translate('agenticObservability.vis.metric.title', {
                    defaultMessage: 'Title',
                  })}
                >
                  <DebouncedFieldText
                    value={styleOptions.title || axisColumnMappings[AxisRole.Value]?.name || ''}
                    placeholder={i18n.translate('agenticObservability.vis.metric.title', {
                      defaultMessage: 'Title',
                    })}
          ...
          <EuiFlexItem>
            <StyleAccordion
              ...
              accordionLabel={i18n.translate(
                'agenticObservability.stylePanel.tabs.metricValueOptions',
                {
            ...
            >
              <EuiFormRow
                label={i18n.translate('agenticObservability.vis.metric.calculation', {
          ...
          <EuiFlexItem>
            <StyleAccordion
              id="metricTextStyles"
              accordionLabel={i18n.translate(
                'agenticObservability.stylePanel.tabs.metricTextSize',
                {
            ...
            >
              <EuiFormRow
                label={i18n.translate('agenticObservability.vis.metric.valueFontSize', {
              ...
              <EuiFormRow
                label={i18n.translate('agenticObservability.vis.metric.titleFontSize', {
              ...
              <EuiFormRow
                label={i18n.translate('agenticObservability.vis.metric.percentageFontSize', {
