...
export const ScatterExclusiveVisOptions = ({
  ...
  return (
    <StyleAccordion
      ...
      id="scatterSection"
      accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.scatter', {
    ...
    >
      {!shouldDisableUseThresholdColor && (
        <EuiFormRow>
          <EuiSwitch
            compressed
            label={i18n.translate('agenticObservability.vis.scatter.useThresholdColor', {
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.vis.scatter.shape', {
      ...
      <EuiFormRow>
        <EuiSwitch
          ...
          compressed
          label={i18n.translate('agenticObservability.vis.scatter.filled', {
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.vis.scatter.colorScale', {
