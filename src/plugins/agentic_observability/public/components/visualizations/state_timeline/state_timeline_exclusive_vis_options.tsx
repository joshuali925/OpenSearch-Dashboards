...
const disconnectValuesOption = [
  {
    ...
    label: i18n.translate('agenticObservability.vis.stateTimeline.disconnectValuesOption.never', {
  ...
  },
  {
    ...
    label: i18n.translate(
      'agenticObservability.vis.stateTimeline.disconnectValuesOption.threshold',
      {
...
const connectValuesOption = [
  {
    id: DisableMode.Never,
    label: i18n.translate('agenticObservability.vis.stateTimeline.connectValuesOption.never', {
      defaultMessage: 'Never',
    }),
  },
  {
    id: DisableMode.Threshold,
    label: i18n.translate('agenticObservability.vis.stateTimeline.connectValuesOption.threshold', {
      defaultMessage: 'Threshold',
    }),
  },
];
...
export const StateTimeLineExclusiveVisOptions = ({
  ...
  return (
    <StyleAccordion
      ...
      accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.stateTimeline', {
    ...
    >
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agenticObservability.vis.statetimeline.useThresholdColor', {
      ...
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agenticObservability.vis.stateTimeline.exclusive.showValues', {
      ...
      <EuiFormRow
        label={i18n.translate('agenticObservability.vis.stateTimeline.exclusive.rowHeight', {
      ...
      <EuiFormRow
        label={i18n.translate(
          'agenticObservability.vis.stateTimeline.exclusive.disconnectValues.disableMode',
          {
      ...
      >
        <EuiButtonGroup
          legend={i18n.translate(
            'agenticObservability.stylePanel.texclusive.disconnectValues.disableMode.options',
            {
      ...
      {styles?.disconnectValues?.disableMode === DisableMode.Threshold && (
        <EuiFormRow
          label={i18n.translate(
            'agenticObservability.stylePanel.texclusive.disconnectValues.disableMode.threshold',
            {
              defaultMessage: 'Threshold',
            }
          )}
      ...
      <EuiFormRow
        label={i18n.translate(
          'agenticObservability.vis.stateTimeline.exclusive.connectValues.connectMode',
          {
      ...
      >
        <EuiButtonGroup
          legend={i18n.translate(
            'agenticObservability.stylePanel.stateTimeline.exclusive.connectValues.options',
            {
      ...
      {styles?.connectNullValues?.connectMode === DisableMode.Threshold && (
        <EuiFormRow
          label={i18n.translate(
            'agenticObservability.stylePanel.texclusive.connectValues.connectMode.threshold',
            {
              defaultMessage: 'Threshold',
            }
          )}
