...
const AXIS_SELECT_LABEL = {
  [AxisRole.X]: i18n.translate('agenticObservability.visualize.axisSelectLabelX', {
    defaultMessage: 'X-Axis',
  }),
  [AxisRole.Y]: i18n.translate('agenticObservability.visualize.axisSelectLabelY', {
    defaultMessage: 'Y-Axis',
  }),
  [AxisRole.COLOR]: i18n.translate('agenticObservability.visualize.axisSelectLabelColor', {
    defaultMessage: 'Color',
  }),
  [AxisRole.FACET]: i18n.translate('agenticObservability.visualize.axisSelectLabelFacet', {
    defaultMessage: 'Split chart by',
  }),
  [AxisRole.SIZE]: i18n.translate('agenticObservability.visualize.axisSelectLabelSize', {
    defaultMessage: 'Size',
  }),
  [AxisRole.Y_SECOND]: i18n.translate('agenticObservability.visualize.axisSelectLabelY2nd', {
    defaultMessage: 'Y-Axis (2nd)',
  }),
  [AxisRole.Value]: i18n.translate('agenticObservability.visualize.axisSelectLabelValue', {
    defaultMessage: 'Value',
  }),
  [AxisRole.Time]: i18n.translate('agenticObservability.visualize.axisSelectLabelTime', {
    defaultMessage: 'Time',
  }),
};
...
export const AxesSelectPanel: React.FC<AxesSelectPanelProps> = ({
  ...
  const getFieldTypeLabel = (type: VisFieldType) => {
    switch (type) {
      case VisFieldType.Categorical:
        return i18n.translate('agenticObservability.stylePanel.fieldType.categorical', {
          defaultMessage: 'Categorical fields',
        });
      case VisFieldType.Date:
        return i18n.translate('agenticObservability.stylePanel.fieldType.date', {
          defaultMessage: 'Date fields',
        });
      default:
        return i18n.translate('agenticObservability.stylePanel.fieldType.numerical', {
  ...
  return (
    <StyleAccordion
      id="axesSelector"
      accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.fields', {
    ...
    >
      <>
        {showSwitch && (
          <EuiFormRow>
            <EuiSwitch
              label={i18n.translate('agenticObservability.vis.axesSwitch.switchAxes', {
