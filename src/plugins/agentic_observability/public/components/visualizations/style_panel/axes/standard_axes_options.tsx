...
const xAxisLabel = i18n.translate('agenticObservability.vis.standardAxes.xAxis', {
  defaultMessage: 'X-Axis',
});

const yAxisLabel = i18n.translate('agenticObservability.vis.standardAxes.yAxis', {
  defaultMessage: 'Y-Axis',
});

const y2AxisLabel = i18n.translate('agenticObservability.vis.standardAxes.y2Axis', {
...
export const AllAxesOptions: React.FC<AllAxesOptionsProps> = ({
  ...
  return (
    <StyleAccordion
      id="allAxesSection"
      accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.allAxes', {
        defaultMessage: 'Axes',
      })}
          ...
          <EuiSplitPanel.Inner paddingSize="s" key={axis.axisRole}>
            ...
            <div>
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('agenticObservability.vis.standardAxes.showAxis', {
              ...
              {axis.show && (
                <>
                  <EuiFormRow
                    label={i18n.translate('agenticObservability.vis.standardAxes.axisTitle', {
                  ...
                  <EuiFormRow
                    label={i18n.translate('agenticObservability.vis.standardAxes.axisPosition', {
                      ...
                      <EuiFormRow>
                        <EuiSwitch
                          ...
                          label={i18n.translate(
                            'agenticObservability.vis.standardAxes.showFullTimeRange',
                            {
                  ...
                  {!disableGrid && (
                    <EuiFormRow>
                      <EuiSwitch
                        ...
                        label={i18n.translate(
                          'agenticObservability.vis.standardAxes.showAxisGrid.switchLabel',
                          {
                  ...
                  <EuiFormRow>
                    <EuiSwitch
                      compressed
                      label={i18n.translate('agenticObservability.vis.standardAxes.showLabels', {
                  ...
                  {axis.labels.show && (
                    <>
                      <EuiFormRow
                        label={i18n.translate(
                          'agenticObservability.vis.standardAxes.labelAlignment',
                          {
                      ...
                      <EuiFormRow
                        label={i18n.translate(
                          'agenticObservability.vis.axis.label.truncate.label',
                          {
