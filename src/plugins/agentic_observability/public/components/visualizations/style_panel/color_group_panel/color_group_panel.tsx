...
export const ColorGroupPanel: React.FC<ColorGroupPanelProps> = ({ color, onChange, onClose }) => {
  ...
  const tabs = [
    {
      id: 'colorGroup',
      name: i18n.translate('agenticObservability.stylePanel.colorGroupPanel.colorGroup', {
    ...
    {
      id: 'customColor',
      name: i18n.translate('agenticObservability.stylePanel.colorGroupPanel.customColor', {
