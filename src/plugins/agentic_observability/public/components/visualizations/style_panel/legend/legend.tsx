...
export const LegendOptionsPanel = ({
  ...
  const legendPositionOptions = [
    {
      ...
      text: i18n.translate('agenticObservability.stylePanel.legend.position.right', {
        defaultMessage: 'Right',
      }),
    },
    {
      value: Positions.BOTTOM,
      text: i18n.translate('agenticObservability.stylePanel.legend.position.bottom', {
        defaultMessage: 'Bottom',
      }),
    },
    {
      value: Positions.LEFT,
      text: i18n.translate('agenticObservability.stylePanel.legend.position.left', {
        defaultMessage: 'Left',
      }),
    },
    {
      value: Positions.TOP,
      text: i18n.translate('agenticObservability.stylePanel.legend.position.top', {
        defaultMessage: 'Top',
      }),
    },
  ];
  ...
  return (
    <StyleAccordion
      id="legendSection"
      accordionLabel={i18n.translate('agenticObservability.stylePanel.tabs.legend', {
    ...
    >
      <EuiSwitch
        compressed
        label={i18n.translate('agenticObservability.stylePanel.legend.mode', {
      ...
      {legendOptions.show && (
        <>
          <EuiSpacer size="s" />
          <EuiFormRow
            label={i18n.translate('agenticObservability.stylePanel.legend.position', {
          ...
          {hasSizeLegend && (
            <EuiFormRow
              label={i18n.translate('agenticObservability.stylePanel.legend.titleForSize', {
            ...
            >
              <DebouncedFieldText
                ...
                placeholder={i18n.translate(
                  'agenticObservability.stylePanel.legend.titleForSize.placeholder',
                  {
