...
const OPTIONS = [
  {
    text: i18n.translate('agenticObservability.vis.stylePanel.percentageColor.standard', {
      defaultMessage: 'Standard',
    }),
    value: 'standard',
  },
  {
    text: i18n.translate('agenticObservability.vis.stylePanel.percentageColor.inverted', {
  ...
  return (
    <>
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agenticObservability.vis.metric.showPercentage', {
      ...
      {props.showPercentage && (
        <EuiFormRow
          label={i18n.translate('agenticObservability.vis.metric.percentageColor', {
