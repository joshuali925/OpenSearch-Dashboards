...
export const Range: React.FC<RangeProps> = ({ id, value, onChange, onDelete }) => {
  ...
  return (
    <EuiFlexGroup
      ...
      gutterSize="s"
      data-test-subj={`agenticObsVisThreshold-${id}`}
    >
      <EuiFlexItem>
        <EuiColorPicker
      ...
      <EuiFlexItem grow={true}>
        <DebouncedFieldNumber
          ...
          placeholder="Value"
          data-test-subj={`agenticObsVisThresholdValue-${id}`}
        />
      </EuiFlexItem>
      ...
      <EuiFlexItem grow={false}>
        <EuiButtonIcon
          ...
          data-test-subj={`agenticObsVisThresholdDeleteButton-${id}`}
        />
      </EuiFlexItem>
    </EuiFlexGroup>
  );
...
export const ThresholdCustomValues: React.FC<ThresholdCustomValuesProps> = ({
  ...
  return (
    <>
      <EuiSpacer size="s" />
      <EuiButton
        data-test-subj="agenticObsVisAddThreshold"
        onClick={handleAddRange}
        fullWidth
        size="s"
      >
        {i18n.translate('agenticObservability.stylePanel.thresholdPanel.addThresholdButton', {
      ...
      <EuiFlexGroup
        ...
        justifyContent="center"
        gutterSize="s"
        data-test-subj="agenticObsVisThresholdBaseColor"
      >
        <EuiFlexItem>
          <EuiColorPicker
            swatches={THRESHOLD_COLORS}
