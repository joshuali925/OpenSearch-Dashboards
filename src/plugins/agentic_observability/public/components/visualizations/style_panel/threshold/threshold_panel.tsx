...
export const ThresholdPanel = ({
  ...
  return (
    <StyleAccordion
      id="thresholdSection"
      accordionLabel={i18n.translate('agenticObservability.stylePanel.threshold.title', {
    ...
    >
      ...
      {showThresholdStyle && (
        <>
          <EuiSpacer size="s" />
          <EuiFormRow
            label={i18n.translate('agenticObservability.stylePanel.threshold.thresholdMode', {
