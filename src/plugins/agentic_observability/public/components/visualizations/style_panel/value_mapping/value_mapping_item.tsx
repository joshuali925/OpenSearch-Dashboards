    ...
    <EuiFlexGroup gutterSize="s" alignItems="center">
      <EuiFlexItem>
        {localMapping.type === 'value' ? (
          <EuiFormRow
            label={i18n.translate('agenticObservability.vis.valueMapping.value', {
          ...
          >
            <DebouncedFieldText
              ...
              placeholder={i18n.translate('agenticObservability.vis.valueMapping.value.input', {
          ...
          <EuiFormRow
            label={i18n.translate('agenticObservability.vis.valueMapping.range', {
      ...
      <EuiFlexItem>
        <EuiFormRow
          label={i18n.translate('agenticObservability.vis.valueMapping.displayText', {
        ...
        >
          <DebouncedFieldText
            ...
            placeholder={i18n.translate('agenticObservability.vis.valueMapping.displayText.input', {
