  ...
  return (
    <EuiModal onClose={onCancel}>
      <EuiModalHeader>
        <EuiModalHeaderTitle>
          {link
            ? i18n.translate('agenticObservability.stylePanel.table.dataLinks.editModalTitle', {
                defaultMessage: 'Edit Link',
              })
            : i18n.translate('agenticObservability.stylePanel.table.dataLinks.addModalTitle', {
      ...
      <EuiModalBody>
        <EuiFormRow
          label={i18n.translate('agenticObservability.stylePanel.table.dataLinks.titleLabel', {
        ...
        <EuiFormRow
          label={i18n.translate('agenticObservability.stylePanel.table.dataLinks.fieldsLabel', {
        ...
        <EuiFormRow
          label={i18n.translate('agenticObservability.stylePanel.table.dataLinks.urlLabel', {
            defaultMessage: 'URL',
          })}
          helpText={i18n.translate('agenticObservability.stylePanel.table.dataLinks.urlHelpText', {
        ...
        <EuiFormRow>
          <EuiSwitch
            ...
            label={i18n.translate(
              'agenticObservability.stylePanel.table.dataLinks.openInNewTabLabel',
              {
      ...
      <EuiModalFooter>
        <EuiSmallButtonEmpty onClick={onCancel}>
          {i18n.translate('agenticObservability.stylePanel.table.dataLinks.cancelButton', {
        ...
        >
          {i18n.translate('agenticObservability.stylePanel.table.dataLinks.saveButton', {
            defaultMessage: 'Save',
          })}
        </EuiSmallButton>
      </EuiModalFooter>
...
export const DataLinkOptions: React.FC<TableVisStyleControlsProps> = ({
  ...
  return (
    <EuiFlexItem grow={false}>
      <StyleAccordion
        id="dataLinkSection"
        accordionLabel={i18n.translate('agenticObservability.stylePanel.table.dataLinks', {
      ...
      >
        <EuiFlexGroup direction="column" gutterSize="s">
          <EuiFlexItem>
            ...
            >
              {i18n.translate('agenticObservability.stylePanel.table.dataLinks.addLinkButton', {
                defaultMessage: 'Add link',
              })}
            </EuiButton>
          </EuiFlexItem>
