...
export const TableFooterOptions: React.FC<TableFooterStyleControlsProps> = ({
  ...
  return (
    <StyleAccordion
      ...
      accordionLabel={i18n.translate('agenticObservability.stylePanel.table.footerSection', {
    ...
    >
      <EuiFormRow>
        <EuiSwitch
          compressed
          label={i18n.translate('agenticObservability.stylePanel.table.showFooter', {
      ...
      {styleOptions.showFooter && (
        <>
          <EuiFormRow
            label={i18n.translate('agenticObservability.stylePanel.table.calculation', {
          ...
          {canAddCalculation && (
            <EuiFormRow>
              ...
              >
                {i18n.translate('agenticObservability.stylePanel.table.addCalculation', {
