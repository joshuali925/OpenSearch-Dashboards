  ...
  return (
    <EuiFlexGroup direction="column" gutterSize="none">
      <EuiFlexItem>
        <StyleAccordion
          id="tableSection"
          accordionLabel={i18n.translate('agenticObservability.stylePanel.table.tableSection', {
        ...
        >
          <EuiFormRow
            label={i18n.translate('agenticObservability.stylePanel.table.pageSize', {
          ...
          >
            <DebouncedFieldNumber
              ...
              placeholder={i18n.translate(
                'agenticObservability.stylePanel.table.pageSize.placeholder',
                {
          ...
          <EuiFormRow
            label={i18n.translate('agenticObservability.stylePanel.table.globalAlignment', {
          ...
          <EuiFormRow
            label={i18n.translate('agenticObservability.stylePanel.table.cellStyle', {
          ...
          <EuiFormRow>
            <EuiSwitch
              compressed
              label={i18n.translate('agenticObservability.stylePanel.table.columnFilter', {
      ...
      <EuiFlexItem grow={false}>
        <StyleAccordion
          id="thresholdSection"
          accordionLabel={i18n.translate('agenticObservability.stylePanel.table.threshold', {
