...
//   useRule: i18n.translate('agenticObservability.visualize.toast.useRule', {
//     defaultMessage: 'Cannot apply previous configured visualization, use rule matched',
//   }),
//   reset: i18n.translate('agenticObservability.visualize.toast.reset', {
//     defaultMessage: 'Cannot apply previous configured visualization, reset',
//   }),
//   metricReset: i18n.translate('agenticObservability.visualize.toast.metricReset', {
//     defaultMessage: 'Cannot apply metric type visualization, reset',
//   }),
//   switchReset: i18n.translate('agenticObservability.visualize.toast.switchReset', {
...
export const VisualizationContainer = React.memo(() => {
  ...
  return (
    <div className="agenticObsVisContainer">
      <EuiPanel
        hasBorder={false}
        hasShadow={false}
        data-test-subj="agenticObsVisualizationLoader"
        className="agenticObsVisPanel"
        paddingSize="none"
      >
        <div className="agenticObsVisPanel__inner">
