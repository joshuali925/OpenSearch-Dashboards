...
export const VisualizationEmptyState = () => {
  const sampleQueries = [
    {
      key: 'faults',
      label: i18n.translate('agenticObservability.visualize.emptyState.sampleQuery.faults', {
...
| head 10`,
    ...
    {
      key: 'slow',
      label: i18n.translate('agenticObservability.visualize.emptyState.sampleQuery.slowOps', {
...
| head 10`,
  ...
  const refLinkLabel = i18n.translate('agenticObservability.visualize.emptyState.docsLink', {
  ...
  return (
    <>
      ...
      <EuiEmptyPrompt
        ...
        title={
          <h3>
            {i18n.translate('agenticObservability.visualize.emptyState.title', {
