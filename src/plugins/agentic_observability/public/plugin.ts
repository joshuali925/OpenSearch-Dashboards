...
export class AgenticObservabilityPlugin
  ...
  public setup(
    ...
    this.docViewsRegistry.addDocView({
      title: i18n.translate('agenticObservability.docViews.trace.timeline.title', {
    ...
    this.docViewsRegistry.addDocView({
      title: i18n.translate('agenticObservability.discover.docViews.table.tableTitle', {
    ...
    this.docViewsRegistry.addDocView({
      title: i18n.translate('agenticObservability.discover.docViews.json.jsonTitle', {
        defaultMessage: 'JSON',
      }),
      order: 20,
    ...
    this.docViewsLinksRegistry.addDocViewLink({
      label: i18n.translate(
        'agenticObservability.discover.docTable.tableRow.viewSurroundingDocumentsLinkText',
        {
    ...
    this.docViewsLinksRegistry.addDocViewLink({
      label: i18n.translate(
        'agenticObservability.discover.docTable.tableRow.viewSingleDocumentLinkText',
        {
      ...
      return {
        ...
        mount: async (params: AppMountParameters) => {
          if (!this.initializeServices) {
            throw Error('Agentic Observability plugin method initializeServices is undefined');
          }
          ...
          // Register tabs (always Traces for Agentic Observability)
    ...
    // Register single Agentic Observability application
    core.application.register(createAgenticObservabilityApp());
  ...
  private registerExploreVisualizationAlias(setupDeps: ExploreSetupDependencies) {
    ...
    setupDeps.visualizations.registerAlias({
      ...
      aliasPath: '#/',
      aliasApp: PLUGIN_ID,
      title: agenticObsVisDisplayName,
      description: i18n.translate('agenticObservability.visualization.description', {
        defaultMessage: 'Create visualization with Discover',
      }),
      icon: 'visualizeApp',
      stage: 'production',
      promotion: {
        buttonText: agenticObsVisDisplayName,
