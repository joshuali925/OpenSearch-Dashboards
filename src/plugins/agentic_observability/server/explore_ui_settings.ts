...
export const agenticObsUiSettings: Record<string, UiSettingsParams> = {
  [DEFAULT_TRACE_COLUMNS_SETTING]: {
    name: i18n.translate('agenticObservability.advancedSettings.defaultTraceColumnsTitle', {
  ...
  [DEFAULT_LOGS_COLUMNS_SETTING]: {
    name: i18n.translate('agenticObservability.advancedSettings.defaultLogsColumnsTitle', {
  ...
  [ENABLE_EXPERIMENTAL_SETTING]: {
    name: i18n.translate('agenticObservability.advancedSettings.enableExperimentalTitle', {
