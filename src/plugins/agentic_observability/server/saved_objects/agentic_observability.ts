...
export const agenticObsSavedObjectType: SavedObjectsType = {
  ...
  management: {
    ...
    getEditUrl(obj) {
      return `/management/opensearch-dashboards/objects/savedAgenticObservability/${encodeURIComponent(
        obj.id
      )}`;
    },
    getInAppUrl(obj) {
      return {
        ...
        path: `/app/agenticObservability/${obj.attributes.type}/#/view/${encodeURIComponent(
          obj.id
        )}`,
