...
export type EchartsMetricVisStyleControlsProps = StyleControlsProps<EchartsMetricChartStyle>;

export const EchartsMetricVisStyleControls: React.FC<EchartsMetricVisStyleControlsProps> = ({
  styleOptions,
  onStyleChange,
  numericalColumns = [],
  categoricalColumns = [],
  ...
  const updateStyleOption = <K extends keyof EchartsMetricChartStyle>(
    key: K,
    value: EchartsMetricChartStyle[K]
  ) => {
      ...
      {hasMappingSelected && (
        <>
          <EuiFlexItem grow={false}>
            ...
            >
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('explore.vis.echartsMetric.useThresholdColor', {
              ...
              <PercentageSelector
                percentageColor={
                  styleOptions.percentageColor ?? defaultEchartsMetricChartStyles.percentageColor
                }
                showPercentage={
                  styleOptions.showPercentage ?? defaultEchartsMetricChartStyles.showPercentage
                }
              ...
              <EuiFormRow>
                <EuiSwitch
                  compressed
                  label={i18n.translate('explore.stylePanel.echartsMetric.title', {
              ...
              {styleOptions.showTitle && (
                <EuiFormRow
                  label={i18n.translate('explore.vis.echartsMetric.title', {
                    defaultMessage: 'Title',
                  })}
                >
                  <DebouncedFieldText
                    value={styleOptions.title || axisColumnMappings[AxisRole.Value]?.name || ''}
                    placeholder={i18n.translate('explore.vis.echartsMetric.title', {
                      defaultMessage: 'Title',
                    })}
          ...
          <EuiFlexItem>
            ...
            >
              <EuiFormRow
                label={i18n.translate('explore.vis.echartsMetric.calculation', {
              ...
              >
                <ValueCalculationSelector
                  selectedValue={
                    ...
                    defaultEchartsMetricChartStyles.valueCalculation
                  }
          ...
          <EuiFlexItem>
            ...
            >
              <EuiFormRow
                label={i18n.translate('explore.vis.echartsMetric.valueFontSize', {
              ...
              <EuiFormRow
                label={i18n.translate('explore.vis.echartsMetric.titleFontSize', {
              ...
              <EuiFormRow
                label={i18n.translate('explore.vis.echartsMetric.percentageFontSize', {
