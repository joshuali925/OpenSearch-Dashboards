    ...
    execute: async (context: QueryUpdateContext) => {
      ...
      try {
        ...
        if (exploreServices && exploreServices.queryService) {
          ...
          const queryInput = document.querySelector('[data-test-subj="queryInput"]') as HTMLTextAreaElement;
          if (queryInput) {
    ...
    execute: async (context: QueryRunContext) => {
      ...
      try {
        ...
        if (exploreServices && exploreServices.queryService) {
          ...
          const runButton = document.querySelector('[data-test-subj="querySubmitButton"]') as HTMLButtonElement;
          if (runButton) {
            runButton.click();
